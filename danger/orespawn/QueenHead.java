...
/*  80 */     getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(OreSpawnMain.TheQueen_stats.health);
...
/*     */     
/* 135 */     List var5 = this.worldObj.getEntitiesWithinAABB(TheQueen.class, this.boundingBox.expand(48.0D, 32.0D, 48.0D));
...
/*     */ 
/*     */       
/* 241 */       List var5 = this.worldObj.getEntitiesWithinAABB(TheQueen.class, this.boundingBox.expand(32.0D, 32.0D, 32.0D));
...
/* 250 */         this.posY = var4.posY + 12.0D;
/* 251 */         this.posX = var4.posX - 30.0D * Math.sin(Math.toRadians(var4.rotationYawHead));
/* 252 */         this.posZ = var4.posZ + 30.0D * Math.cos(Math.toRadians(var4.rotationYawHead));
...
/* Location:              C:\Users\Admin\Downloads\orespawn-1.7.10-20.3-deobf.jar!\danger\orespawn\QueenHead.class
