...
/*     */     
/*  78 */     this.textureWidth = 512;
/*  79 */     this.textureHeight = 256;
/*     */     
/*  81 */     this.lclaw1 = new ModelRenderer(this, 300, 111);
/*  82 */     this.lclaw1.addBox(-3.0F, 0.0F, -3.0F, 2, 3, 6);
/*  83 */     this.lclaw1.setRotationPoint(7.0F, 21.0F, 11.0F);
/*  84 */     this.lclaw1.setTextureSize(512, 256);
/*  85 */     this.lclaw1.mirror = true;
/*  86 */     setRotation(this.lclaw1, 0.0F, 0.6632251F, 0.0F);
/*  87 */     this.body = new ModelRenderer(this, 407, 3);
/*  88 */     this.body.addBox(-6.0F, -12.0F, -9.0F, 12, 17, 9);
/*  89 */     this.body.setRotationPoint(0.0F, -2.0F, 9.0F);
/*  90 */     this.body.setTextureSize(512, 256);
/*  91 */     this.body.mirror = true;
/*  92 */     setRotation(this.body, -0.3141593F, 0.0F, 0.0F);
/*  93 */     this.leftleg1 = new ModelRenderer(this, 300, 0);
/*  94 */     this.leftleg1.addBox(-3.0F, -4.0F, -21.0F, 6, 11, 11);
/*  95 */     this.leftleg1.setRotationPoint(9.0F, 2.0F, 26.0F);
/*  96 */     this.leftleg1.setTextureSize(512, 256);
/*  97 */     this.leftleg1.mirror = true;
/*  98 */     setRotation(this.leftleg1, -0.5759587F, 0.0F, 0.0F);
/*  99 */     this.tail1 = new ModelRenderer(this, 400, 75);
/* 100 */     this.tail1.addBox(-6.0F, -6.0F, 0.0F, 10, 12, 14);
/* 101 */     this.tail1.setRotationPoint(1.0F, -5.0F, 22.0F);
/* 102 */     this.tail1.setTextureSize(512, 256);
/* 103 */     this.tail1.mirror = true;
/* 104 */     setRotation(this.tail1, -0.1745329F, 0.0F, 0.0F);
/* 105 */     this.leftleg2 = new ModelRenderer(this, 300, 23);
/* 106 */     this.leftleg2.addBox(-3.0F, -10.0F, -5.0F, 5, 13, 7);
/* 107 */     this.leftleg2.setRotationPoint(9.0F, 2.0F, 26.0F);
/* 108 */     this.leftleg2.setTextureSize(512, 256);
/* 109 */     this.leftleg2.mirror = true;
/* 110 */     setRotation(this.leftleg2, 0.9773844F, 0.0F, 0.0F);
/* 111 */     this.body2 = new ModelRenderer(this, 400, 39);
/* 112 */     this.body2.addBox(0.0F, -3.0F, -3.0F, 12, 18, 16);
/* 113 */     this.body2.setRotationPoint(-6.0F, -11.0F, 10.0F);
/* 114 */     this.body2.setTextureSize(512, 256);
/* 115 */     this.body2.mirror = true;
/* 116 */     setRotation(this.body2, -0.1047198F, 0.0F, 0.0F);
/* 117 */     this.leftleg3 = new ModelRenderer(this, 300, 51);
/* 118 */     this.leftleg3.addBox(-1.0F, -19.0F, 0.0F, 4, 18, 6);
/* 119 */     this.leftleg3.setRotationPoint(7.0F, 21.0F, 11.0F);
/* 120 */     this.leftleg3.setTextureSize(512, 256);
/* 121 */     this.leftleg3.mirror = true;
/* 122 */     setRotation(this.leftleg3, -0.5235988F, 0.0F, 0.0F);
/* 123 */     this.tail2 = new ModelRenderer(this, 400, 103);
/* 124 */     this.tail2.addBox(-4.0F, -4.0F, 0.0F, 8, 10, 12);
/* 125 */     this.tail2.setRotationPoint(0.0F, -4.0F, 35.0F);
/* 126 */     this.tail2.setTextureSize(512, 256);
/* 127 */     this.tail2.mirror = true;
/* 128 */     setRotation(this.tail2, -0.1396263F, 0.0F, 0.0F);
/* 129 */     this.tail3 = new ModelRenderer(this, 400, 127);
/* 130 */     this.tail3.addBox(-3.0F, -3.0F, 0.0F, 6, 8, 12);
/* 131 */     this.tail3.setRotationPoint(0.0F, -3.0F, 46.0F);
/* 132 */     this.tail3.setTextureSize(512, 256);
/* 133 */     this.tail3.mirror = true;
/* 134 */     setRotation(this.tail3, -0.1396263F, 0.0F, 0.0F);
/* 135 */     this.lclaw2 = new ModelRenderer(this, 300, 76);
/* 136 */     this.lclaw2.addBox(-1.0F, -1.0F, -6.0F, 4, 4, 13);
/* 137 */     this.lclaw2.setRotationPoint(7.0F, 21.0F, 11.0F);
/* 138 */     this.lclaw2.setTextureSize(512, 256);
/* 139 */     this.lclaw2.mirror = true;
/* 140 */     setRotation(this.lclaw2, 0.0F, 0.0F, 0.0F);
/* 141 */     this.lclaw3 = new ModelRenderer(this, 300, 95);
/* 142 */     this.lclaw3.addBox(2.0F, 0.0F, -6.0F, 2, 3, 10);
/* 143 */     this.lclaw3.setRotationPoint(7.0F, 21.0F, 11.0F);
/* 144 */     this.lclaw3.setTextureSize(512, 256);
/* 145 */     this.lclaw3.mirror = true;
/* 146 */     setRotation(this.lclaw3, 0.0F, -0.6632251F, 0.0F);
/* 147 */     this.lclaw4 = new ModelRenderer(this, 308, 123);
/* 148 */     this.lclaw4.addBox(0.0F, 0.0F, -10.0F, 2, 3, 4);
/* 149 */     this.lclaw4.setRotationPoint(7.0F, 21.0F, 11.0F);
...
/* 154 */     this.lclaw5.addBox(-2.5F, 1.0F, -5.0F, 1, 2, 2);
/* 155 */     this.lclaw5.setRotationPoint(7.0F, 21.0F, 11.0F);
...
/* 160 */     this.lclaw6.addBox(2.5F, 1.0F, -9.0F, 1, 2, 3);
/* 161 */     this.lclaw6.setRotationPoint(7.0F, 21.0F, 11.0F);
...
/* 166 */     this.lclaw7.addBox(0.0F, 1.0F, 7.0F, 1, 2, 3);
/* 167 */     this.lclaw7.setRotationPoint(7.0F, 21.0F, 11.0F);
...
/* 172 */     this.neck3.addBox(-3.0F, -3.0F, -6.0F, 6, 6, 8);
/* 173 */     this.neck3.setRotationPoint(0.0F, -24.0F, -9.0F);
/* 174 */     this.neck3.setTextureSize(512, 256);
/* 175 */     this.neck3.mirror = true;
/* 176 */     setRotation(this.neck3, -0.2443461F, 0.0F, 0.0F);
/* 177 */     this.head3 = new ModelRenderer(this, 130, 32);
/* 178 */     this.head3.addBox(-3.0F, -6.0F, -15.0F, 6, 6, 17);
/* 179 */     this.head3.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 180 */     this.head3.setTextureSize(512, 256);
/* 181 */     this.head3.mirror = true;
/* 182 */     setRotation(this.head3, -0.2443461F, 0.0F, 0.0F);
/* 183 */     this.jaw1 = new ModelRenderer(this, 143, 114);
/* 184 */     this.jaw1.addBox(-3.0F, 1.0F, -14.0F, 6, 3, 15);
/* 185 */     this.jaw1.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 186 */     this.jaw1.setTextureSize(512, 256);
/* 187 */     this.jaw1.mirror = true;
/* 188 */     setRotation(this.jaw1, 0.1919862F, 0.0F, 0.0F);
/* 189 */     this.tooth1 = new ModelRenderer(this, 0, 0);
/* 190 */     this.tooth1.addBox(-3.0F, 0.0F, -14.0F, 1, 3, 1);
/* 191 */     this.tooth1.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 192 */     this.tooth1.setTextureSize(512, 256);
/* 193 */     this.tooth1.mirror = true;
/* 194 */     setRotation(this.tooth1, -0.2443461F, 0.0F, 0.0F);
/* 195 */     this.tooth2 = new ModelRenderer(this, 0, 0);
/* 196 */     this.tooth2.addBox(-0.5F, 0.0F, -14.0F, 1, 2, 1);
/* 197 */     this.tooth2.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 198 */     this.tooth2.setTextureSize(512, 256);
/* 199 */     this.tooth2.mirror = true;
/* 200 */     setRotation(this.tooth2, -0.2443461F, 0.0F, 0.0F);
/* 201 */     this.tooth3 = new ModelRenderer(this, 0, 0);
/* 202 */     this.tooth3.addBox(2.0F, 0.0F, -14.0F, 1, 3, 1);
/* 203 */     this.tooth3.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 204 */     this.tooth3.setTextureSize(512, 256);
/* 205 */     this.tooth3.mirror = true;
/* 206 */     setRotation(this.tooth3, -0.2443461F, 0.0F, 0.0F);
/* 207 */     this.tooth4 = new ModelRenderer(this, 0, 0);
/* 208 */     this.tooth4.addBox(-2.0F, 0.0F, -12.0F, 1, 3, 1);
/* 209 */     this.tooth4.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 210 */     this.tooth4.setTextureSize(512, 256);
/* 211 */     this.tooth4.mirror = true;
/* 212 */     setRotation(this.tooth4, -0.2443461F, 0.0F, 0.0F);
/* 213 */     this.tooth5 = new ModelRenderer(this, 0, 0);
/* 214 */     this.tooth5.addBox(1.0F, 0.0F, -12.0F, 1, 3, 1);
/* 215 */     this.tooth5.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 216 */     this.tooth5.setTextureSize(512, 256);
/* 217 */     this.tooth5.mirror = true;
/* 218 */     setRotation(this.tooth5, -0.2443461F, 0.0F, 0.0F);
/* 219 */     this.jaw5 = new ModelRenderer(this, 151, 135);
/* 220 */     this.jaw5.addBox(-4.0F, 1.0F, -4.0F, 8, 4, 7);
/* 221 */     this.jaw5.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 222 */     this.jaw5.setTextureSize(512, 256);
/* 223 */     this.jaw5.mirror = true;
/* 224 */     setRotation(this.jaw5, 0.1919862F, 0.0F, 0.0F);
/* 225 */     this.head7 = new ModelRenderer(this, 185, 34);
/* 226 */     this.head7.addBox(-4.0F, -7.0F, -3.0F, 8, 7, 10);
/* 227 */     this.head7.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 228 */     this.head7.setTextureSize(512, 256);
/* 229 */     this.head7.mirror = true;
/* 230 */     setRotation(this.head7, -0.2443461F, 0.0F, 0.0F);
/* 231 */     this.tooth6 = new ModelRenderer(this, 0, 0);
/* 232 */     this.tooth6.addBox(-3.0F, 0.0F, -10.0F, 1, 2, 1);
/* 233 */     this.tooth6.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 234 */     this.tooth6.setTextureSize(512, 256);
/* 235 */     this.tooth6.mirror = true;
/* 236 */     setRotation(this.tooth6, -0.2443461F, 0.0F, 0.0F);
/* 237 */     this.tooth7 = new ModelRenderer(this, 0, 0);
/* 238 */     this.tooth7.addBox(2.0F, 0.0F, -10.0F, 1, 2, 1);
/* 239 */     this.tooth7.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 240 */     this.tooth7.setTextureSize(512, 256);
/* 241 */     this.tooth7.mirror = true;
/* 242 */     setRotation(this.tooth7, -0.2443461F, 0.0F, 0.0F);
/* 243 */     this.tooth8 = new ModelRenderer(this, 0, 0);
/* 244 */     this.tooth8.addBox(-2.0F, 0.0F, -8.0F, 1, 2, 1);
/* 245 */     this.tooth8.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 246 */     this.tooth8.setTextureSize(512, 256);
/* 247 */     this.tooth8.mirror = true;
/* 248 */     setRotation(this.tooth8, -0.2443461F, 0.0F, 0.0F);
/* 249 */     this.tooth9 = new ModelRenderer(this, 0, 0);
/* 250 */     this.tooth9.addBox(1.0F, 0.0F, -8.0F, 1, 2, 1);
/* 251 */     this.tooth9.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 252 */     this.tooth9.setTextureSize(512, 256);
/* 253 */     this.tooth9.mirror = true;
/* 254 */     setRotation(this.tooth9, -0.2443461F, 0.0F, 0.0F);
/* 255 */     this.tooth10 = new ModelRenderer(this, 0, 0);
/* 256 */     this.tooth10.addBox(-3.0F, 0.0F, -6.0F, 1, 2, 1);
/* 257 */     this.tooth10.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 258 */     this.tooth10.setTextureSize(512, 256);
/* 259 */     this.tooth10.mirror = true;
/* 260 */     setRotation(this.tooth10, -0.2443461F, 0.0F, 0.0F);
/* 261 */     this.tooth11 = new ModelRenderer(this, 0, 0);
/* 262 */     this.tooth11.addBox(2.0F, 0.0F, -6.0F, 1, 2, 1);
/* 263 */     this.tooth11.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 264 */     this.tooth11.setTextureSize(512, 256);
/* 265 */     this.tooth11.mirror = true;
/* 266 */     setRotation(this.tooth11, -0.2443461F, 0.0F, 0.0F);
/* 267 */     this.tooth12 = new ModelRenderer(this, 0, 0);
/* 268 */     this.tooth12.addBox(-2.0F, 0.0F, -4.0F, 1, 1, 1);
/* 269 */     this.tooth12.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 270 */     this.tooth12.setTextureSize(512, 256);
/* 271 */     this.tooth12.mirror = true;
/* 272 */     setRotation(this.tooth12, -0.2443461F, 0.0F, 0.0F);
/* 273 */     this.tooth13 = new ModelRenderer(this, -1, 0);
/* 274 */     this.tooth13.addBox(1.0F, 0.0F, -4.0F, 1, 1, 1);
/* 275 */     this.tooth13.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 276 */     this.tooth13.setTextureSize(512, 256);
/* 277 */     this.tooth13.mirror = true;
/* 278 */     setRotation(this.tooth13, -0.2443461F, 0.0F, 0.0F);
/* 279 */     this.rightleg1 = new ModelRenderer(this, 246, 0);
/* 280 */     this.rightleg1.addBox(-2.0F, -4.0F, -21.0F, 6, 11, 11);
/* 281 */     this.rightleg1.setRotationPoint(-10.0F, 2.0F, 26.0F);
/* 282 */     this.rightleg1.setTextureSize(512, 256);
/* 283 */     this.rightleg1.mirror = true;
/* 284 */     setRotation(this.rightleg1, -0.5934119F, 0.0F, 0.0F);
/* 285 */     this.rightleg2 = new ModelRenderer(this, 250, 24);
/* 286 */     this.rightleg2.addBox(-1.0F, -10.0F, -5.0F, 5, 13, 7);
/* 287 */     this.rightleg2.setRotationPoint(-10.0F, 2.0F, 26.0F);
/* 288 */     this.rightleg2.setTextureSize(512, 256);
/* 289 */     this.rightleg2.mirror = true;
/* 290 */     setRotation(this.rightleg2, 0.9773844F, 0.0F, 0.0F);
/* 291 */     this.tooth14 = new ModelRenderer(this, 0, 0);
/* 292 */     this.tooth14.addBox(0.5F, -2.0F, -14.0F, 1, 3, 1);
/* 293 */     this.tooth14.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 294 */     this.tooth14.setTextureSize(512, 256);
/* 295 */     this.tooth14.mirror = true;
/* 296 */     setRotation(this.tooth14, 0.1919862F, 0.0F, 0.0F);
/* 297 */     this.tooth15 = new ModelRenderer(this, 0, 0);
/* 298 */     this.tooth15.addBox(-1.5F, -2.0F, -14.0F, 1, 3, 1);
/* 299 */     this.tooth15.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 300 */     this.tooth15.setTextureSize(512, 256);
/* 301 */     this.tooth15.mirror = true;
/* 302 */     setRotation(this.tooth15, 0.1919862F, 0.0F, 0.0F);
/* 303 */     this.tooth16 = new ModelRenderer(this, 0, 0);
/* 304 */     this.tooth16.addBox(2.0F, -1.0F, -12.0F, 1, 2, 1);
/* 305 */     this.tooth16.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 306 */     this.tooth16.setTextureSize(512, 256);
/* 307 */     this.tooth16.mirror = true;
/* 308 */     setRotation(this.tooth16, 0.1919862F, 0.0F, 0.0F);
/* 309 */     this.tooth17 = new ModelRenderer(this, 0, 0);
/* 310 */     this.tooth17.addBox(-3.0F, -1.0F, -12.0F, 1, 2, 1);
/* 311 */     this.tooth17.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 312 */     this.tooth17.setTextureSize(512, 256);
/* 313 */     this.tooth17.mirror = true;
/* 314 */     setRotation(this.tooth17, 0.1919862F, 0.0F, 0.0F);
/* 315 */     this.tooth18 = new ModelRenderer(this, 0, 0);
/* 316 */     this.tooth18.addBox(1.0F, -1.0F, -10.0F, 1, 2, 1);
/* 317 */     this.tooth18.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 318 */     this.tooth18.setTextureSize(512, 256);
/* 319 */     this.tooth18.mirror = true;
/* 320 */     setRotation(this.tooth18, 0.1919862F, 0.0F, 0.0F);
/* 321 */     this.tooth19 = new ModelRenderer(this, 0, 0);
/* 322 */     this.tooth19.addBox(-2.0F, -1.0F, -10.0F, 1, 2, 1);
/* 323 */     this.tooth19.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 324 */     this.tooth19.setTextureSize(512, 256);
/* 325 */     this.tooth19.mirror = true;
/* 326 */     setRotation(this.tooth19, 0.1919862F, 0.0F, 0.0F);
/* 327 */     this.tooth20 = new ModelRenderer(this, 0, 0);
/* 328 */     this.tooth20.addBox(-3.0F, -1.0F, -8.0F, 1, 2, 1);
/* 329 */     this.tooth20.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 330 */     this.tooth20.setTextureSize(512, 256);
/* 331 */     this.tooth20.mirror = true;
/* 332 */     setRotation(this.tooth20, 0.1919862F, 0.0F, 0.0F);
/* 333 */     this.tooth21 = new ModelRenderer(this, 0, 0);
/* 334 */     this.tooth21.addBox(2.0F, -1.0F, -8.0F, 1, 2, 1);
/* 335 */     this.tooth21.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 336 */     this.tooth21.setTextureSize(512, 256);
/* 337 */     this.tooth21.mirror = true;
/* 338 */     setRotation(this.tooth21, 0.1919862F, 0.0F, 0.0F);
/* 339 */     this.tooth22 = new ModelRenderer(this, 0, 0);
/* 340 */     this.tooth22.addBox(1.0F, 0.0F, -6.0F, 1, 1, 1);
/* 341 */     this.tooth22.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 342 */     this.tooth22.setTextureSize(512, 256);
/* 343 */     this.tooth22.mirror = true;
/* 344 */     setRotation(this.tooth22, 0.1919862F, 0.0F, 0.0F);
/* 345 */     this.tooth23 = new ModelRenderer(this, 0, 0);
/* 346 */     this.tooth23.addBox(-2.0F, 0.0F, -6.0F, 1, 1, 1);
/* 347 */     this.tooth23.setRotationPoint(0.0F, -26.0F, -14.0F);
/* 348 */     this.tooth23.setTextureSize(512, 256);
/* 349 */     this.tooth23.mirror = true;
/* 350 */     setRotation(this.tooth23, 0.1919862F, 0.0F, 0.0F);
/* 351 */     this.rightleg3 = new ModelRenderer(this, 250, 47);
/* 352 */     this.rightleg3.addBox(-2.0F, -19.0F, 0.0F, 4, 18, 6);
/* 353 */     this.rightleg3.setRotationPoint(-8.0F, 21.0F, 11.0F);
/* 354 */     this.rightleg3.setTextureSize(512, 256);
/* 355 */     this.rightleg3.mirror = true;
/* 356 */     setRotation(this.rightleg3, -0.5235988F, 0.0F, 0.0F);
/* 357 */     this.rclaw2 = new ModelRenderer(this, 250, 76);
/* 358 */     this.rclaw2.addBox(-2.0F, -1.0F, -6.0F, 4, 4, 13);
/* 359 */     this.rclaw2.setRotationPoint(-8.0F, 21.0F, 11.0F);
/* 360 */     this.rclaw2.setTextureSize(512, 256);
/* 361 */     this.rclaw2.mirror = true;
/* 362 */     setRotation(this.rclaw2, 0.0F, 0.0F, 0.0F);
/* 363 */     this.rclaw4 = new ModelRenderer(this, 247, 123);
/* 364 */     this.rclaw4.addBox(-1.0F, 0.0F, -10.0F, 2, 3, 4);
/* 365 */     this.rclaw4.setRotationPoint(-8.0F, 21.0F, 11.0F);
/* 366 */     this.rclaw4.setTextureSize(512, 256);
/* 367 */     this.rclaw4.mirror = true;
/* 368 */     setRotation(this.rclaw4, 0.0F, 0.0F, 0.0F);
/* 369 */     this.rclaw1 = new ModelRenderer(this, 250, 111);
/* 370 */     this.rclaw1.addBox(2.0F, 0.0F, -3.0F, 2, 3, 6);
/* 371 */     this.rclaw1.setRotationPoint(-8.0F, 21.0F, 11.0F);
/* 372 */     this.rclaw1.setTextureSize(512, 256);
/* 373 */     this.rclaw1.mirror = true;
/* 374 */     setRotation(this.rclaw1, 0.0F, -0.6632251F, 0.0F);
/* 375 */     this.rclaw5 = new ModelRenderer(this, 261, 123);
/* 376 */     this.rclaw5.addBox(2.5F, 1.0F, -5.0F, 1, 2, 2);
/* 377 */     this.rclaw5.setRotationPoint(-8.0F, 21.0F, 11.0F);
/* 378 */     this.rclaw5.setTextureSize(512, 256);
/* 379 */     this.rclaw5.mirror = true;
/* 380 */     setRotation(this.rclaw5, 0.0F, -0.6632251F, 0.0F);
/* 381 */     this.rclaw7 = new ModelRenderer(this, 283, 123);
/* 382 */     this.rclaw7.addBox(0.0F, 1.0F, 7.0F, 1, 2, 3);
/* 383 */     this.rclaw7.setRotationPoint(-8.0F, 21.0F, 11.0F);
/* 384 */     this.rclaw7.setTextureSize(512, 256);
/* 385 */     this.rclaw7.mirror = true;
/* 386 */     setRotation(this.rclaw7, 0.0F, 0.0F, 0.0F);
/* 387 */     this.rclaw3 = new ModelRenderer(this, 250, 95);
/* 388 */     this.rclaw3.addBox(-3.0F, 0.0F, -6.0F, 2, 3, 10);
/* 389 */     this.rclaw3.setRotationPoint(-8.0F, 21.0F, 11.0F);
/* 390 */     this.rclaw3.setTextureSize(512, 256);
/* 391 */     this.rclaw3.mirror = true;
/* 392 */     setRotation(this.rclaw3, 0.0F, 0.6632251F, 0.0F);
/* 393 */     this.rclaw6 = new ModelRenderer(this, 270, 123);
/* 394 */     this.rclaw6.addBox(-2.5F, 1.0F, -9.0F, 1, 2, 3);
/* 395 */     this.rclaw6.setRotationPoint(-8.0F, 21.0F, 11.0F);
/* 396 */     this.rclaw6.setTextureSize(512, 256);
/* 397 */     this.rclaw6.mirror = true;
/* 398 */     setRotation(this.rclaw6, 0.0F, 0.6632251F, 0.0F);
/* 399 */     this.neck1 = new ModelRenderer(this, 45, 0);
/* 400 */     this.neck1.addBox(-5.0F, -6.0F, -14.0F, 10, 12, 15);
/* 401 */     this.neck1.setRotationPoint(0.0F, -9.0F, 5.0F);
/* 402 */     this.neck1.setTextureSize(512, 256);
/* 403 */     this.neck1.mirror = true;
/* 404 */     setRotation(this.neck1, -0.837758F, 0.0F, 0.0F);
/* 405 */     this.neck2 = new ModelRenderer(this, 48, 29);
/* 406 */     this.neck2.addBox(-4.5F, -4.0F, -10.0F, 9, 9, 10);
/* 407 */     this.neck2.setRotationPoint(0.0F, -19.0F, -2.0F);
/* 408 */     this.neck2.setTextureSize(512, 256);
/* 409 */     this.neck2.mirror = true;
/* 410 */     setRotation(this.neck2, -0.7853982F, 0.0F, 0.0F);
/* 411 */     this.tail4 = new ModelRenderer(this, 400, 150);
/* 412 */     this.tail4.addBox(-2.0F, -3.0F, 0.0F, 4, 6, 16);
/* 413 */     this.tail4.setRotationPoint(0.0F, -1.0F, 56.0F);
/* 414 */     this.tail4.setTextureSize(512, 256);
/* 415 */     this.tail4.mirror = true;
/* 416 */     setRotation(this.tail4, -0.1396263F, 0.0F, 0.0F);
/* 417 */     this.Spike1 = new ModelRenderer(this, 0, 100);
/* 418 */     this.Spike1.addBox(-2.0F, -16.0F, -1.0F, 4, 16, 18);
/* 419 */     this.Spike1.setRotationPoint(0.0F, -4.0F, 7.0F);
/* 420 */     this.Spike1.setTextureSize(512, 256);
/* 421 */     this.Spike1.mirror = true;
/* 422 */     setRotation(this.Spike1, 0.5061455F, 0.0F, 0.0F);
/* 423 */     this.Spike2 = new ModelRenderer(this, 0, 72);
/* 424 */     this.Spike2.addBox(-1.5F, -12.0F, 0.0F, 3, 12, 10);
/* 425 */     this.Spike2.setRotationPoint(0.0F, 0.0F, 29.0F);
/* 426 */     this.Spike2.setTextureSize(512, 256);
/* 427 */     this.Spike2.mirror = true;
/* 428 */     setRotation(this.Spike2, 0.4886922F, 0.0F, 0.0F);
/* 429 */     this.Spike3 = new ModelRenderer(this, 0, 44);
/* 430 */     this.Spike3.addBox(-1.0F, -7.0F, 0.0F, 2, 8, 7);
/* 431 */     this.Spike3.setRotationPoint(0.0F, -2.0F, 41.0F);
/* 432 */     this.Spike3.setTextureSize(512, 256);
/* 433 */     this.Spike3.mirror = true;
...
/* 664 */     model.rotateAngleX = x;
/* 665 */     model.rotateAngleY = y;
/* 666 */     model.rotateAngleZ = z;
/*     */   }
/*     */ 
/*     */   
/*     */   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
/* 671 */     super.setRotationAngles(par1, par2, par3, par4, par5, par6, par7Entity);
/*     */   }
/*     */ }


/* Location:              C:\Users\Admin\Downloads\orespawn-1.7.10-20.3-deobf.jar!\danger\orespawn\ModelNastysaurus.class
