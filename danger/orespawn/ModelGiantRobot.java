...
/*  36 */     this.textureWidth = 256;
/*  37 */     this.textureHeight = 512;
/*     */     
/*  39 */     this.Hip = new ModelRenderer(this, 0, 0);
/*  40 */     this.Hip.addBox(-4.0F, -4.0F, -15.0F, 8, 8, 30);
/*  41 */     this.Hip.setRotationPoint(0.0F, -60.0F, 0.0F);
/*  42 */     this.Hip.setTextureSize(64, 32);
/*  43 */     this.Hip.mirror = true;
/*  44 */     setRotation(this.Hip, 0.0F, 0.0F, 0.0F);
/*  45 */     this.Thigh = new ModelRenderer(this, 0, 115);
/*  46 */     this.Thigh.addBox(-3.0F, -3.0F, -3.0F, 6, 43, 6);
/*  47 */     this.Thigh.setRotationPoint(0.0F, -58.0F, 0.0F);
/*  48 */     this.Thigh.setTextureSize(64, 32);
/*  49 */     this.Thigh.mirror = true;
/*  50 */     setRotation(this.Thigh, 0.0F, 0.0F, 0.0F);
/*  51 */     this.Shin = new ModelRenderer(this, 0, 167);
/*  52 */     this.Shin.addBox(-3.0F, -3.0F, -3.0F, 6, 43, 6);
/*  53 */     this.Shin.setRotationPoint(0.0F, -18.0F, 0.0F);
/*  54 */     this.Shin.setTextureSize(64, 32);
/*  55 */     this.Shin.mirror = true;
/*  56 */     setRotation(this.Shin, 0.0F, 0.0F, 0.0F);
/*  57 */     this.Foot1 = new ModelRenderer(this, 0, 282);
/*  58 */     this.Foot1.addBox(-7.0F, 38.0F, -11.0F, 14, 4, 17);
/*  59 */     this.Foot1.setRotationPoint(0.0F, -18.0F, 0.0F);
/*  60 */     this.Foot1.setTextureSize(64, 32);
/*  61 */     this.Foot1.mirror = true;
/*  62 */     setRotation(this.Foot1, 0.0F, 0.0F, 0.0F);
/*  63 */     this.Foot2 = new ModelRenderer(this, 0, 246);
/*  64 */     this.Foot2.addBox(-6.0F, 19.0F, -8.0F, 12, 19, 13);
/*  65 */     this.Foot2.setRotationPoint(0.0F, -18.0F, 0.0F);
/*  66 */     this.Foot2.setTextureSize(64, 32);
/*  67 */     this.Foot2.mirror = true;
/*  68 */     setRotation(this.Foot2, 0.0F, 0.0F, 0.0F);
/*  69 */     this.Foot3 = new ModelRenderer(this, 0, 219);
/*  70 */     this.Foot3.addBox(-5.0F, 5.0F, -5.0F, 10, 14, 9);
/*  71 */     this.Foot3.setRotationPoint(0.0F, -18.0F, 0.0F);
/*  72 */     this.Foot3.setTextureSize(64, 32);
/*  73 */     this.Foot3.mirror = true;
/*  74 */     setRotation(this.Foot3, 0.0F, 0.0F, 0.0F);
/*  75 */     this.Thigh2 = new ModelRenderer(this, 0, 43);
/*  76 */     this.Thigh2.addBox(-7.0F, -8.0F, -7.0F, 14, 24, 14);
/*  77 */     this.Thigh2.setRotationPoint(0.0F, -58.0F, 0.0F);
/*  78 */     this.Thigh2.setTextureSize(64, 32);
/*  79 */     this.Thigh2.mirror = true;
/*  80 */     setRotation(this.Thigh2, 0.0F, 0.0F, 0.0F);
/*  81 */     this.Thigh3 = new ModelRenderer(this, 0, 84);
/*  82 */     this.Thigh3.addBox(-5.0F, 16.0F, -5.0F, 10, 17, 10);
/*  83 */     this.Thigh3.setRotationPoint(0.0F, -58.0F, 0.0F);
/*  84 */     this.Thigh3.setTextureSize(64, 32);
/*  85 */     this.Thigh3.mirror = true;
/*  86 */     setRotation(this.Thigh3, 0.0F, 0.0F, 0.0F);
/*  87 */     this.Back1 = new ModelRenderer(this, 125, 138);
/*  88 */     this.Back1.addBox(-4.0F, -20.0F, -4.0F, 8, 24, 8);
/*  89 */     this.Back1.setRotationPoint(0.0F, -60.0F, 0.0F);
/*  90 */     this.Back1.setTextureSize(64, 32);
/*  91 */     this.Back1.mirror = true;
/*  92 */     setRotation(this.Back1, 0.0F, 0.0F, 0.0F);
/*  93 */     this.Back2 = new ModelRenderer(this, 125, 95);
/*  94 */     this.Back2.addBox(-13.0F, -42.0F, -10.0F, 26, 24, 16);
/*  95 */     this.Back2.setRotationPoint(0.0F, -60.0F, 0.0F);
/*  96 */     this.Back2.setTextureSize(64, 32);
/*  97 */     this.Back2.mirror = true;
/*  98 */     setRotation(this.Back2, 0.0F, 0.0F, 0.0F);
/*  99 */     this.Back3 = new ModelRenderer(this, 125, 43);
/* 100 */     this.Back3.addBox(-17.0F, -68.0F, -13.0F, 34, 26, 20);
/* 101 */     this.Back3.setRotationPoint(0.0F, -60.0F, 0.0F);
/* 102 */     this.Back3.setTextureSize(64, 32);
/* 103 */     this.Back3.mirror = true;
/* 104 */     setRotation(this.Back3, 0.0F, 0.0F, 0.0F);
/* 105 */     this.Shoulders = new ModelRenderer(this, 60, 200);
/* 106 */     this.Shoulders.addBox(-22.0F, -64.0F, -4.0F, 44, 8, 8);
/* 107 */     this.Shoulders.setRotationPoint(0.0F, -60.0F, 0.0F);
/* 108 */     this.Shoulders.setTextureSize(64, 32);
/* 109 */     this.Shoulders.mirror = true;
/* 110 */     setRotation(this.Shoulders, 0.0F, 0.0F, 0.0F);
/* 111 */     this.Neck = new ModelRenderer(this, 125, 29);
/* 112 */     this.Neck.addBox(-4.0F, -70.0F, -4.0F, 8, 2, 8);
/* 113 */     this.Neck.setRotationPoint(0.0F, -60.0F, 0.0F);
/* 114 */     this.Neck.setTextureSize(64, 32);
/* 115 */     this.Neck.mirror = true;
/* 116 */     setRotation(this.Neck, 0.0F, 0.0F, 0.0F);
/* 117 */     this.Head = new ModelRenderer(this, 127, 0);
/* 118 */     this.Head.addBox(-7.0F, -82.0F, -7.0F, 14, 12, 14);
/* 119 */     this.Head.setRotationPoint(0.0F, -60.0F, 0.0F);
/* 120 */     this.Head.setTextureSize(64, 32);
/* 121 */     this.Head.mirror = true;
/* 122 */     setRotation(this.Head, 0.0F, 0.0F, 0.0F);
/* 123 */     this.Arm1 = new ModelRenderer(this, 77, 250);
/* 124 */     this.Arm1.addBox(-6.0F, -6.0F, -6.0F, 12, 21, 12);
/* 125 */     this.Arm1.setRotationPoint(28.0F, -120.0F, 0.0F);
/* 126 */     this.Arm1.setTextureSize(64, 32);
/* 127 */     this.Arm1.mirror = true;
/* 128 */     setRotation(this.Arm1, 0.0F, 0.0F, 0.0F);
/* 129 */     this.Arm2 = new ModelRenderer(this, 73, 300);
/* 130 */     this.Arm2.addBox(-4.0F, 15.0F, -4.0F, 8, 24, 8);
/* 131 */     this.Arm2.setRotationPoint(28.0F, -120.0F, 0.0F);
/* 132 */     this.Arm2.setTextureSize(64, 32);
/* 133 */     this.Arm2.mirror = true;
/* 134 */     setRotation(this.Arm2, 0.0F, 0.0F, 0.0F);
/* 135 */     this.Arm3 = new ModelRenderer(this, 61, 350);
/* 136 */     this.Arm3.addBox(-3.0F, -3.0F, -3.0F, 6, 33, 6);
/* 137 */     this.Arm3.setRotationPoint(28.0F, -81.0F, 0.0F);
/* 138 */     this.Arm3.setTextureSize(64, 32);
/* 139 */     this.Arm3.mirror = true;
/* 140 */     setRotation(this.Arm3, 0.0F, 0.0F, 0.0F);
/* 141 */     this.Knuckles = new ModelRenderer(this, 56, 400);
/* 142 */     this.Knuckles.addBox(-7.0F, 30.0F, -5.0F, 14, 12, 10);
/* 143 */     this.Knuckles.setRotationPoint(28.0F, -81.0F, 0.0F);
/* 144 */     this.Knuckles.setTextureSize(256, 512);
/* 145 */     this.Knuckles.mirror = true;
/* 146 */     setRotation(this.Knuckles, 0.0F, 0.0F, 0.0F);
/*     */     
/* 148 */     this.hipy = this.Hip.rotationPointY;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 285 */     model.rotateAngleX = x;
/* 286 */     model.rotateAngleY = y;
/* 287 */     model.rotateAngleZ = z;
/*     */   }
/*     */ 
/*     */   
/*     */   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
/* 292 */     super.setRotationAngles(par1, par2, par3, par4, par5, par6, par7Entity);
/*     */   }
/*     */ }


/* Location:              C:\Users\Admin\Downloads\orespawn-1.7.10-20.3-deobf.jar!\danger\orespawn\ModelGiantRobot.class
