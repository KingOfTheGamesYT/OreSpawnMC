...
/*      */     
/*  142 */     this.textureWidth = 2048;
/*  143 */     this.textureHeight = 2048;
/*      */     
/*  145 */     this.LCClaw1 = new ModelRenderer(this, 0, 1450);
/*  146 */     this.LCClaw1.addBox(-5.0F, -5.0F, -20.0F, 10, 10, 20);
/*  147 */     this.LCClaw1.setRotationPoint(52.0F, -2.0F, -7.0F);
/*  148 */     this.LCClaw1.setTextureSize(64, 32);
/*  149 */     this.LCClaw1.mirror = true;
/*  150 */     setRotation(this.LCClaw1, 0.3839724F, 0.0F, 0.0F);
/*  151 */     this.LThigh = new ModelRenderer(this, 0, 1050);
/*  152 */     this.LThigh.addBox(0.0F, -14.0F, -21.0F, 25, 34, 42);
/*  153 */     this.LThigh.setRotationPoint(40.0F, -91.0F, 2.0F);
/*  154 */     this.LThigh.setTextureSize(64, 32);
/*  155 */     this.LThigh.mirror = true;
/*  156 */     setRotation(this.LThigh, 0.7853982F, 0.0F, 0.0F);
/*  157 */     this.LUpperLeg = new ModelRenderer(this, 0, 1137);
/*  158 */     this.LUpperLeg.addBox(0.0F, 12.0F, -16.0F, 24, 52, 24);
/*  159 */     this.LUpperLeg.setRotationPoint(40.0F, -91.0F, 2.0F);
/*  160 */     this.LUpperLeg.setTextureSize(64, 32);
/*  161 */     this.LUpperLeg.mirror = true;
/*  162 */     setRotation(this.LUpperLeg, 0.7853982F, 0.0F, 0.0F);
/*  163 */     this.TailTip = new ModelRenderer(this, 500, 102);
/*  164 */     this.TailTip.addBox(-51.0F, -3.0F, 0.0F, 100, 6, 36);
/*  165 */     this.TailTip.setRotationPoint(0.0F, -86.0F, 308.0F);
/*  166 */     this.TailTip.setTextureSize(64, 32);
/*  167 */     this.TailTip.mirror = true;
/*  168 */     setRotation(this.TailTip, 0.0F, 0.0F, 0.0F);
/*  169 */     this.Tail1 = new ModelRenderer(this, 500, 614);
/*  170 */     this.Tail1.addBox(-32.0F, 0.0F, 0.0F, 64, 52, 58);
/*  171 */     this.Tail1.setRotationPoint(0.0F, -114.0F, 29.0F);
/*  172 */     this.Tail1.setTextureSize(64, 32);
/*  173 */     this.Tail1.mirror = true;
/*  174 */     setRotation(this.Tail1, 0.0F, 0.0F, 0.0F);
/*  175 */     this.Tail2 = new ModelRenderer(this, 500, 520);
/*  176 */     this.Tail2.addBox(-25.0F, -19.0F, -3.0F, 50, 42, 46);
/*  177 */     this.Tail2.setRotationPoint(0.0F, -90.0F, 79.0F);
/*  178 */     this.Tail2.setTextureSize(64, 32);
/*  179 */     this.Tail2.mirror = true;
/*  180 */     setRotation(this.Tail2, 0.0F, 0.0F, 0.0F);
/*  181 */     this.Tail3 = new ModelRenderer(this, 500, 432);
/*  182 */     this.Tail3.addBox(-20.0F, -18.0F, 0.0F, 40, 36, 45);
/*  183 */     this.Tail3.setRotationPoint(0.0F, -88.0F, 117.0F);
/*  184 */     this.Tail3.setTextureSize(64, 32);
/*  185 */     this.Tail3.mirror = true;
/*  186 */     setRotation(this.Tail3, 0.0F, 0.0F, 0.0F);
/*  187 */     this.Tail4 = new ModelRenderer(this, 500, 355);
/*  188 */     this.Tail4.addBox(-16.0F, -15.0F, 0.0F, 32, 30, 38);
/*  189 */     this.Tail4.setRotationPoint(0.0F, -87.0F, 156.0F);
/*  190 */     this.Tail4.setTextureSize(64, 32);
/*  191 */     this.Tail4.mirror = true;
/*  192 */     setRotation(this.Tail4, 0.0F, 0.0F, 0.0F);
/*  193 */     this.Tail5 = new ModelRenderer(this, 500, 286);
/*  194 */     this.Tail5.addBox(-13.0F, -12.0F, 0.0F, 26, 24, 38);
/*  195 */     this.Tail5.setRotationPoint(0.0F, -87.0F, 189.0F);
/*  196 */     this.Tail5.setTextureSize(64, 32);
/*  197 */     this.Tail5.mirror = true;
/*  198 */     setRotation(this.Tail5, 0.0F, 0.0F, 0.0F);
/*  199 */     this.Tail6 = new ModelRenderer(this, 500, 218);
/*  200 */     this.Tail6.addBox(-10.0F, -9.0F, 0.0F, 20, 18, 44);
/*  201 */     this.Tail6.setRotationPoint(0.0F, -87.0F, 222.0F);
/*  202 */     this.Tail6.setTextureSize(64, 32);
/*  203 */     this.Tail6.mirror = true;
/*  204 */     setRotation(this.Tail6, 0.0F, 0.0F, 0.0F);
/*  205 */     this.Tail7 = new ModelRenderer(this, 500, 150);
/*  206 */     this.Tail7.addBox(-8.0F, -6.0F, -7.0F, 16, 12, 49);
/*  207 */     this.Tail7.setRotationPoint(0.0F, -87.0F, 268.0F);
/*  208 */     this.Tail7.setTextureSize(64, 32);
/*  209 */     this.Tail7.mirror = true;
/*  210 */     setRotation(this.Tail7, 0.0F, 0.0F, 0.0F);
/*  211 */     this.Body1 = new ModelRenderer(this, 500, 732);
/*  212 */     this.Body1.addBox(-40.0F, -32.0F, -36.0F, 80, 64, 72);
/*  213 */     this.Body1.setRotationPoint(0.0F, -89.0F, 1.0F);
/*  214 */     this.Body1.setTextureSize(64, 32);
/*  215 */     this.Body1.mirror = true;
/*  216 */     setRotation(this.Body1, 0.0F, 0.0F, 0.0F);
/*  217 */     this.Chest = new ModelRenderer(this, 0, 73);
/*  218 */     this.Chest.addBox(-41.0F, -32.0F, -60.0F, 82, 44, 60);
/*  219 */     this.Chest.setRotationPoint(0.0F, -91.0F, -22.0F);
/*  220 */     this.Chest.setTextureSize(64, 32);
/*  221 */     this.Chest.mirror = true;
/*  222 */     setRotation(this.Chest, 0.0F, 0.0F, 0.0F);
/*  223 */     this.NeckC1 = new ModelRenderer(this, 700, 1100);
/*  224 */     this.NeckC1.addBox(-12.0F, -12.0F, -24.0F, 24, 24, 24);
/*  225 */     this.NeckC1.setRotationPoint(0.0F, -113.0F, -76.0F);
/*  226 */     this.NeckC1.setTextureSize(64, 32);
/*  227 */     this.NeckC1.mirror = true;
/*  228 */     setRotation(this.NeckC1, -0.1047198F, 0.0F, 0.0F);
/*  229 */     this.LLowerLeg = new ModelRenderer(this, 0, 1220);
/*  230 */     this.LLowerLeg.addBox(-11.0F, 0.0F, -10.0F, 22, 59, 20);
/*  231 */     this.LLowerLeg.setRotationPoint(52.0F, -52.0F, 36.0F);
/*  232 */     this.LLowerLeg.setTextureSize(64, 32);
/*  233 */     this.LLowerLeg.mirror = true;
/*  234 */     setRotation(this.LLowerLeg, -0.6283185F, 0.0F, 0.0F);
/*  235 */     this.LFoot = new ModelRenderer(this, 0, 1307);
/*  236 */     this.LFoot.addBox(-18.0F, 59.0F, -10.0F, 36, 12, 20);
/*  237 */     this.LFoot.setRotationPoint(52.0F, -52.0F, 36.0F);
/*  238 */     this.LFoot.setTextureSize(64, 32);
/*  239 */     this.LFoot.mirror = true;
/*  240 */     setRotation(this.LFoot, -0.6283185F, 0.0F, 0.0F);
/*  241 */     this.LLClaw1 = new ModelRenderer(this, 0, 1400);
/*  242 */     this.LLClaw1.addBox(-5.0F, -5.0F, -20.0F, 10, 10, 20);
/*  243 */     this.LLClaw1.setRotationPoint(67.0F, -2.0F, -7.0F);
/*  244 */     this.LLClaw1.setTextureSize(64, 32);
/*  245 */     this.LLClaw1.mirror = true;
/*  246 */     setRotation(this.LLClaw1, 0.3839724F, 0.0F, 0.0F);
/*  247 */     this.LRClaw1 = new ModelRenderer(this, 0, 1500);
/*  248 */     this.LRClaw1.addBox(-5.0F, -5.0F, -20.0F, 10, 10, 20);
/*  249 */     this.LRClaw1.setRotationPoint(37.0F, -2.0F, -7.0F);
/*  250 */     this.LRClaw1.setTextureSize(64, 32);
/*  251 */     this.LRClaw1.mirror = true;
/*  252 */     setRotation(this.LRClaw1, 0.3839724F, 0.0F, 0.0F);
/*  253 */     this.LCClaw2 = new ModelRenderer(this, 0, 1600);
/*  254 */     this.LCClaw2.addBox(-2.0F, -7.0F, -46.0F, 4, 7, 28);
/*  255 */     this.LCClaw2.setRotationPoint(52.0F, -2.0F, -7.0F);
/*  256 */     this.LCClaw2.setTextureSize(64, 32);
/*  257 */     this.LCClaw2.mirror = true;
/*  258 */     setRotation(this.LCClaw2, 0.6457718F, 0.0F, 0.0F);
/*  259 */     this.LLClaw2 = new ModelRenderer(this, 0, 1550);
/*  260 */     this.LLClaw2.addBox(-2.0F, -7.0F, -46.0F, 4, 7, 28);
/*  261 */     this.LLClaw2.setRotationPoint(67.0F, -2.0F, -7.0F);
/*  262 */     this.LLClaw2.setTextureSize(64, 32);
/*  263 */     this.LLClaw2.mirror = true;
/*  264 */     setRotation(this.LLClaw2, 0.6457718F, 0.0F, 0.0F);
/*  265 */     this.TailSpike = new ModelRenderer(this, 500, 0);
/*  266 */     this.TailSpike.addBox(-2.0F, -1.0F, -7.0F, 4, 4, 53);
/*  267 */     this.TailSpike.setRotationPoint(0.0F, -87.0F, 375.0F);
/*  268 */     this.TailSpike.setTextureSize(64, 32);
/*  269 */     this.TailSpike.mirror = true;
/*  270 */     setRotation(this.TailSpike, 0.0F, 0.0F, 0.0F);
/*  271 */     this.LRClaw2 = new ModelRenderer(this, 0, 1650);
/*  272 */     this.LRClaw2.addBox(-2.0F, -7.0F, -46.0F, 4, 7, 28);
/*  273 */     this.LRClaw2.setRotationPoint(37.0F, -2.0F, -7.0F);
/*  274 */     this.LRClaw2.setTextureSize(64, 32);
/*  275 */     this.LRClaw2.mirror = true;
/*  276 */     setRotation(this.LRClaw2, 0.6457718F, 0.0F, 0.0F);
/*  277 */     this.LClawRear = new ModelRenderer(this, 0, 1350);
/*  278 */     this.LClawRear.addBox(-2.0F, -3.0F, 0.0F, 4, 9, 28);
/*  279 */     this.LClawRear.setRotationPoint(52.0F, 4.0F, 4.0F);
/*  280 */     this.LClawRear.setTextureSize(64, 32);
/*  281 */     this.LClawRear.mirror = true;
/*  282 */     setRotation(this.LClawRear, -0.9250245F, 0.0F, 0.0F);
/*  283 */     this.NeckL1 = new ModelRenderer(this, 500, 1100);
/*  284 */     this.NeckL1.addBox(-12.0F, -12.0F, -24.0F, 24, 24, 24);
/*  285 */     this.NeckL1.setRotationPoint(30.0F, -113.0F, -76.0F);
/*  286 */     this.NeckL1.setTextureSize(64, 32);
/*  287 */     this.NeckL1.mirror = true;
/*  288 */     setRotation(this.NeckL1, -0.0523599F, -0.1047198F, 0.0F);
/*  289 */     this.NeckR1 = new ModelRenderer(this, 900, 1100);
/*  290 */     this.NeckR1.addBox(-12.0F, -12.0F, -24.0F, 24, 24, 24);
/*  291 */     this.NeckR1.setRotationPoint(-30.0F, -113.0F, -76.0F);
/*  292 */     this.NeckR1.setTextureSize(64, 32);
/*  293 */     this.NeckR1.mirror = true;
/*  294 */     setRotation(this.NeckR1, -0.0523599F, 0.1047198F, 0.0F);
/*  295 */     this.RThigh = new ModelRenderer(this, 200, 1050);
/*  296 */     this.RThigh.addBox(0.0F, -14.0F, -21.0F, 25, 34, 42);
/*  297 */     this.RThigh.setRotationPoint(-65.0F, -91.0F, 2.0F);
/*  298 */     this.RThigh.setTextureSize(64, 32);
/*  299 */     this.RThigh.mirror = true;
/*  300 */     setRotation(this.RThigh, 0.7853982F, 0.0F, 0.0F);
/*  301 */     this.RUpperLeg = new ModelRenderer(this, 200, 1137);
/*  302 */     this.RUpperLeg.addBox(0.0F, 12.0F, -16.0F, 24, 52, 24);
/*  303 */     this.RUpperLeg.setRotationPoint(-64.0F, -91.0F, 2.0F);
/*  304 */     this.RUpperLeg.setTextureSize(64, 32);
/*  305 */     this.RUpperLeg.mirror = true;
/*  306 */     setRotation(this.RUpperLeg, 0.7853982F, 0.0F, 0.0F);
/*  307 */     this.RLowerLeg = new ModelRenderer(this, 200, 1220);
/*  308 */     this.RLowerLeg.addBox(-4.0F, 0.0F, -10.0F, 22, 59, 20);
/*  309 */     this.RLowerLeg.setRotationPoint(-59.0F, -52.0F, 36.0F);
/*  310 */     this.RLowerLeg.setTextureSize(64, 32);
/*  311 */     this.RLowerLeg.mirror = true;
/*  312 */     setRotation(this.RLowerLeg, -0.6283185F, 0.0F, 0.0F);
/*  313 */     this.RFoot = new ModelRenderer(this, 200, 1307);
/*  314 */     this.RFoot.addBox(-11.0F, 59.0F, -10.0F, 36, 12, 20);
/*  315 */     this.RFoot.setRotationPoint(-59.0F, -52.0F, 36.0F);
/*  316 */     this.RFoot.setTextureSize(64, 32);
/*  317 */     this.RFoot.mirror = true;
/*  318 */     setRotation(this.RFoot, -0.6283185F, 0.0F, 0.0F);
/*  319 */     this.RClawRear = new ModelRenderer(this, 200, 1350);
/*  320 */     this.RClawRear.addBox(-2.0F, -3.0F, 0.0F, 4, 9, 28);
/*  321 */     this.RClawRear.setRotationPoint(-52.0F, 4.0F, 4.0F);
/*  322 */     this.RClawRear.setTextureSize(64, 32);
/*  323 */     this.RClawRear.mirror = true;
/*  324 */     setRotation(this.RClawRear, -0.9250245F, 0.0F, 0.0F);
/*  325 */     this.RLClaw1 = new ModelRenderer(this, 200, 1400);
/*  326 */     this.RLClaw1.addBox(-5.0F, -5.0F, -20.0F, 10, 10, 20);
/*  327 */     this.RLClaw1.setRotationPoint(-37.0F, -2.0F, -7.0F);
/*  328 */     this.RLClaw1.setTextureSize(64, 32);
/*  329 */     this.RLClaw1.mirror = true;
/*  330 */     setRotation(this.RLClaw1, 0.3839724F, 0.0F, 0.0F);
/*  331 */     this.RCClaw1 = new ModelRenderer(this, 200, 1450);
/*  332 */     this.RCClaw1.addBox(-5.0F, -5.0F, -20.0F, 10, 10, 20);
/*  333 */     this.RCClaw1.setRotationPoint(-52.0F, -2.0F, -7.0F);
/*  334 */     this.RCClaw1.setTextureSize(64, 32);
/*  335 */     this.RCClaw1.mirror = true;
/*  336 */     setRotation(this.RCClaw1, 0.3839724F, 0.0F, 0.0F);
/*  337 */     this.RRClaw1 = new ModelRenderer(this, 200, 1500);
/*  338 */     this.RRClaw1.addBox(-5.0F, -5.0F, -20.0F, 10, 10, 20);
/*  339 */     this.RRClaw1.setRotationPoint(-67.0F, -2.0F, -7.0F);
/*  340 */     this.RRClaw1.setTextureSize(64, 32);
/*  341 */     this.RRClaw1.mirror = true;
/*  342 */     setRotation(this.RRClaw1, 0.3839724F, 0.0F, 0.0F);
/*  343 */     this.RLClaw2 = new ModelRenderer(this, 200, 1550);
/*  344 */     this.RLClaw2.addBox(-2.0F, -7.0F, -46.0F, 4, 7, 28);
/*  345 */     this.RLClaw2.setRotationPoint(-37.0F, -2.0F, -7.0F);
/*  346 */     this.RLClaw2.setTextureSize(64, 32);
/*  347 */     this.RLClaw2.mirror = true;
/*  348 */     setRotation(this.RLClaw2, 0.6457718F, 0.0F, 0.0F);
/*  349 */     this.RCClaw2 = new ModelRenderer(this, 200, 1600);
/*  350 */     this.RCClaw2.addBox(-2.0F, -7.0F, -46.0F, 4, 7, 28);
/*  351 */     this.RCClaw2.setRotationPoint(-52.0F, -2.0F, -7.0F);
/*  352 */     this.RCClaw2.setTextureSize(64, 32);
/*  353 */     this.RCClaw2.mirror = true;
/*  354 */     setRotation(this.RCClaw2, 0.6457718F, 0.0F, 0.0F);
/*  355 */     this.RRClaw2 = new ModelRenderer(this, 200, 1650);
/*  356 */     this.RRClaw2.addBox(-2.0F, -7.0F, -46.0F, 4, 7, 28);
/*  357 */     this.RRClaw2.setRotationPoint(-67.0F, -2.0F, -7.0F);
/*  358 */     this.RRClaw2.setTextureSize(64, 32);
/*  359 */     this.RRClaw2.mirror = true;
/*  360 */     setRotation(this.RRClaw2, 0.6457718F, 0.0F, 0.0F);
/*  361 */     this.NeckL2 = new ModelRenderer(this, 500, 1154);
/*  362 */     this.NeckL2.addBox(-11.0F, -11.0F, -40.0F, 22, 22, 40);
/*  363 */     this.NeckL2.setRotationPoint(32.0F, -114.0F, -95.0F);
/*  364 */     this.NeckL2.setTextureSize(64, 32);
/*  365 */     this.NeckL2.mirror = true;
/*  366 */     setRotation(this.NeckL2, 0.0F, -0.1745329F, 0.0F);
/*  367 */     this.NeckC2 = new ModelRenderer(this, 700, 1154);
/*  368 */     this.NeckC2.addBox(-11.0F, -11.0F, -40.0F, 22, 22, 40);
/*  369 */     this.NeckC2.setRotationPoint(0.0F, -115.0F, -95.0F);
/*  370 */     this.NeckC2.setTextureSize(64, 32);
/*  371 */     this.NeckC2.mirror = true;
/*  372 */     setRotation(this.NeckC2, -0.1570796F, 0.0F, 0.0F);
/*  373 */     this.NeckR2 = new ModelRenderer(this, 900, 1154);
/*  374 */     this.NeckR2.addBox(-11.0F, -11.0F, -40.0F, 22, 22, 40);
/*  375 */     this.NeckR2.setRotationPoint(-32.0F, -114.0F, -95.0F);
/*  376 */     this.NeckR2.setTextureSize(64, 32);
/*  377 */     this.NeckR2.mirror = true;
/*  378 */     setRotation(this.NeckR2, -0.0523599F, 0.1745329F, 0.0F);
/*  379 */     this.NeckL3 = new ModelRenderer(this, 500, 1222);
/*  380 */     this.NeckL3.addBox(-10.0F, -10.0F, -40.0F, 20, 20, 40);
/*  381 */     this.NeckL3.setRotationPoint(38.0F, -114.0F, -131.0F);
/*  382 */     this.NeckL3.setTextureSize(64, 32);
/*  383 */     this.NeckL3.mirror = true;
/*  384 */     setRotation(this.NeckL3, 0.0698132F, -0.2617994F, 0.0F);
/*  385 */     this.NeckC3 = new ModelRenderer(this, 700, 1222);
/*  386 */     this.NeckC3.addBox(-10.0F, -10.0F, -40.0F, 20, 20, 40);
/*  387 */     this.NeckC3.setRotationPoint(0.0F, -120.0F, -131.0F);
/*  388 */     this.NeckC3.setTextureSize(64, 32);
/*  389 */     this.NeckC3.mirror = true;
/*  390 */     setRotation(this.NeckC3, -0.2094395F, 0.0F, 0.0F);
/*  391 */     this.NeckR3 = new ModelRenderer(this, 900, 1222);
/*  392 */     this.NeckR3.addBox(-10.0F, -10.0F, -40.0F, 20, 20, 40);
/*  393 */     this.NeckR3.setRotationPoint(-37.0F, -116.0F, -128.0F);
/*  394 */     this.NeckR3.setTextureSize(64, 32);
/*  395 */     this.NeckR3.mirror = true;
/*  396 */     setRotation(this.NeckR3, -0.0523599F, 0.3141593F, 0.0F);
/*  397 */     this.NeckL4 = new ModelRenderer(this, 500, 1300);
/*  398 */     this.NeckL4.addBox(-9.0F, -9.0F, -40.0F, 18, 18, 40);
/*  399 */     this.NeckL4.setRotationPoint(46.0F, -112.0F, -163.0F);
/*  400 */     this.NeckL4.setTextureSize(64, 32);
/*  401 */     this.NeckL4.mirror = true;
/*  402 */     setRotation(this.NeckL4, 0.1396263F, -0.3839724F, 0.0F);
/*  403 */     this.LHead1 = new ModelRenderer(this, 500, 1425);
/*  404 */     this.LHead1.addBox(-13.0F, -13.0F, -30.0F, 26, 26, 30);
/*  405 */     this.LHead1.setRotationPoint(59.0F, -114.0F, -195.0F);
/*  406 */     this.LHead1.setTextureSize(64, 32);
/*  407 */     this.LHead1.mirror = true;
/*  408 */     setRotation(this.LHead1, 0.1396263F, -0.3839724F, 0.0F);
/*  409 */     this.LHead2 = new ModelRenderer(this, 500, 1550);
/*  410 */     this.LHead2.addBox(-10.0F, -7.0F, -58.0F, 20, 20, 28);
/*  411 */     this.LHead2.setRotationPoint(59.0F, -114.0F, -195.0F);
/*  412 */     this.LHead2.setTextureSize(64, 32);
/*  413 */     this.LHead2.mirror = true;
/*  414 */     setRotation(this.LHead2, 0.1396263F, -0.3839724F, 0.0F);
/*  415 */     this.LHead3 = new ModelRenderer(this, 500, 1605);
/*  416 */     this.LHead3.addBox(-8.0F, -3.0F, -83.0F, 16, 16, 26);
/*  417 */     this.LHead3.setRotationPoint(59.0F, -114.0F, -195.0F);
/*  418 */     this.LHead3.setTextureSize(64, 32);
/*  419 */     this.LHead3.mirror = true;
/*  420 */     setRotation(this.LHead3, 0.1396263F, -0.3839724F, 0.0F);
/*  421 */     this.LJaw1 = new ModelRenderer(this, 500, 1660);
/*  422 */     this.LJaw1.addBox(-14.0F, -2.0F, -14.0F, 28, 7, 16);
/*  423 */     this.LJaw1.setRotationPoint(59.0F, -100.0F, -196.0F);
/*  424 */     this.LJaw1.setTextureSize(64, 32);
/*  425 */     this.LJaw1.mirror = true;
/*  426 */     setRotation(this.LJaw1, 0.2443461F, -0.3839724F, 0.0F);
/*  427 */     this.LJaw2 = new ModelRenderer(this, 500, 1700);
/*  428 */     this.LJaw2.addBox(-12.0F, -2.0F, -55.0F, 24, 6, 46);
/*  429 */     this.LJaw2.setRotationPoint(59.0F, -100.0F, -196.0F);
/*  430 */     this.LJaw2.setTextureSize(64, 32);
/*  431 */     this.LJaw2.mirror = true;
/*  432 */     setRotation(this.LJaw2, 0.2443461F, -0.3839724F, 0.0F);
/*  433 */     this.LJaw3 = new ModelRenderer(this, 500, 1765);
/*  434 */     this.LJaw3.addBox(-10.0F, -2.0F, -77.0F, 20, 6, 22);
/*  435 */     this.LJaw3.setRotationPoint(59.0F, -100.0F, -196.0F);
/*  436 */     this.LJaw3.setTextureSize(64, 32);
/*  437 */     this.LJaw3.mirror = true;
/*  438 */     setRotation(this.LJaw3, 0.2443461F, -0.3839724F, 0.0F);
/*  439 */     this.LTooth1 = new ModelRenderer(this, 10, 0);
/*  440 */     this.LTooth1.addBox(-10.0F, -10.0F, -77.0F, 2, 8, 2);
/*  441 */     this.LTooth1.setRotationPoint(59.0F, -100.0F, -196.0F);
/*  442 */     this.LTooth1.setTextureSize(64, 32);
/*  443 */     this.LTooth1.mirror = true;
/*  444 */     setRotation(this.LTooth1, 0.2443461F, -0.3839724F, 0.0F);
/*  445 */     this.LTooth2 = new ModelRenderer(this, 20, 0);
/*  446 */     this.LTooth2.addBox(8.0F, -10.0F, -77.0F, 2, 8, 2);
/*  447 */     this.LTooth2.setRotationPoint(59.0F, -100.0F, -196.0F);
/*  448 */     this.LTooth2.setTextureSize(64, 32);
/*  449 */     this.LTooth2.mirror = true;
/*  450 */     setRotation(this.LTooth2, 0.2443461F, -0.3839724F, 0.0F);
/*  451 */     this.LTooth3 = new ModelRenderer(this, 30, 0);
/*  452 */     this.LTooth3.addBox(-12.0F, -8.0F, -55.0F, 2, 6, 2);
/*  453 */     this.LTooth3.setRotationPoint(59.0F, -100.0F, -196.0F);
/*  454 */     this.LTooth3.setTextureSize(64, 32);
/*  455 */     this.LTooth3.mirror = true;
/*  456 */     setRotation(this.LTooth3, 0.2443461F, -0.3839724F, 0.0F);
/*  457 */     this.LTooth4 = new ModelRenderer(this, 40, 0);
/*  458 */     this.LTooth4.addBox(10.0F, -8.0F, -55.0F, 2, 6, 2);
/*  459 */     this.LTooth4.setRotationPoint(59.0F, -100.0F, -196.0F);
/*  460 */     this.LTooth4.setTextureSize(64, 32);
/*  461 */     this.LTooth4.mirror = true;
/*  462 */     setRotation(this.LTooth4, 0.2443461F, -0.3839724F, 0.0F);
/*  463 */     this.NeckC4 = new ModelRenderer(this, 700, 1300);
/*  464 */     this.NeckC4.addBox(-9.0F, -9.0F, -40.0F, 18, 18, 40);
/*  465 */     this.NeckC4.setRotationPoint(0.0F, -126.0F, -162.0F);
/*  466 */     this.NeckC4.setTextureSize(64, 32);
/*  467 */     this.NeckC4.mirror = true;
/*  468 */     setRotation(this.NeckC4, -0.2617994F, 0.0F, 0.0F);
/*  469 */     this.NeckR4 = new ModelRenderer(this, 900, 1300);
/*  470 */     this.NeckR4.addBox(-9.0F, -9.0F, -40.0F, 18, 18, 40);
/*  471 */     this.NeckR4.setRotationPoint(-47.0F, -118.0F, -161.0F);
/*  472 */     this.NeckR4.setTextureSize(64, 32);
/*  473 */     this.NeckR4.mirror = true;
/*  474 */     setRotation(this.NeckR4, -0.1047198F, 0.3665191F, 0.0F);
/*  475 */     this.CHead1 = new ModelRenderer(this, 700, 1425);
/*  476 */     this.CHead1.addBox(-13.0F, -13.0F, -30.0F, 26, 26, 30);
/*  477 */     this.CHead1.setRotationPoint(0.0F, -141.0F, -195.0F);
/*  478 */     this.CHead1.setTextureSize(64, 32);
/*  479 */     this.CHead1.mirror = true;
/*  480 */     setRotation(this.CHead1, -0.296706F, 0.0F, 0.0F);
/*  481 */     this.RHead1 = new ModelRenderer(this, 900, 1425);
/*  482 */     this.RHead1.addBox(-13.0F, -13.0F, -30.0F, 26, 26, 30);
/*  483 */     this.RHead1.setRotationPoint(-60.0F, -128.0F, -195.0F);
/*  484 */     this.RHead1.setTextureSize(64, 32);
/*  485 */     this.RHead1.mirror = true;
/*  486 */     setRotation(this.RHead1, -0.122173F, 0.418879F, 0.0F);
/*  487 */     this.CHead2 = new ModelRenderer(this, 700, 1550);
/*  488 */     this.CHead2.addBox(-10.0F, -7.0F, -58.0F, 20, 20, 28);
/*  489 */     this.CHead2.setRotationPoint(0.0F, -141.0F, -195.0F);
/*  490 */     this.CHead2.setTextureSize(64, 32);
/*  491 */     this.CHead2.mirror = true;
/*  492 */     setRotation(this.CHead2, -0.296706F, 0.0F, 0.0F);
/*  493 */     this.RHead2 = new ModelRenderer(this, 900, 1550);
/*  494 */     this.RHead2.addBox(-10.0F, -7.0F, -58.0F, 20, 20, 28);
/*  495 */     this.RHead2.setRotationPoint(-60.0F, -128.0F, -195.0F);
/*  496 */     this.RHead2.setTextureSize(64, 32);
/*  497 */     this.RHead2.mirror = true;
/*  498 */     setRotation(this.RHead2, -0.122173F, 0.418879F, 0.0F);
/*  499 */     this.CHead3 = new ModelRenderer(this, 700, 1605);
/*  500 */     this.CHead3.addBox(-8.0F, -3.0F, -83.0F, 16, 16, 26);
/*  501 */     this.CHead3.setRotationPoint(0.0F, -141.0F, -195.0F);
/*  502 */     this.CHead3.setTextureSize(64, 32);
/*  503 */     this.CHead3.mirror = true;
/*  504 */     setRotation(this.CHead3, -0.296706F, 0.0F, 0.0F);
/*  505 */     this.RHead3 = new ModelRenderer(this, 900, 1605);
/*  506 */     this.RHead3.addBox(-8.0F, -3.0F, -83.0F, 16, 16, 26);
/*  507 */     this.RHead3.setRotationPoint(-60.0F, -128.0F, -195.0F);
/*  508 */     this.RHead3.setTextureSize(64, 32);
/*  509 */     this.RHead3.mirror = true;
/*  510 */     setRotation(this.RHead3, -0.122173F, 0.418879F, 0.0F);
/*  511 */     this.CJaw1 = new ModelRenderer(this, 700, 1660);
/*  512 */     this.CJaw1.addBox(-14.0F, -2.0F, -14.0F, 28, 7, 16);
/*  513 */     this.CJaw1.setRotationPoint(0.0F, -130.0F, -201.0F);
/*  514 */     this.CJaw1.setTextureSize(64, 32);
/*  515 */     this.CJaw1.mirror = true;
/*  516 */     setRotation(this.CJaw1, -0.1047198F, 0.0F, 0.0F);
/*  517 */     this.CJaw2 = new ModelRenderer(this, 700, 1700);
/*  518 */     this.CJaw2.addBox(-12.0F, -2.0F, -55.0F, 24, 6, 46);
/*  519 */     this.CJaw2.setRotationPoint(0.0F, -130.0F, -201.0F);
/*  520 */     this.CJaw2.setTextureSize(64, 32);
/*  521 */     this.CJaw2.mirror = true;
/*  522 */     setRotation(this.CJaw2, -0.1047198F, 0.0F, 0.0F);
/*  523 */     this.CJaw3 = new ModelRenderer(this, 700, 1765);
/*  524 */     this.CJaw3.addBox(-10.0F, -2.0F, -77.0F, 20, 6, 22);
/*  525 */     this.CJaw3.setRotationPoint(0.0F, -130.0F, -201.0F);
/*  526 */     this.CJaw3.setTextureSize(64, 32);
/*  527 */     this.CJaw3.mirror = true;
/*  528 */     setRotation(this.CJaw3, -0.1047198F, 0.0F, 0.0F);
/*  529 */     this.RJaw1 = new ModelRenderer(this, 900, 1660);
/*  530 */     this.RJaw1.addBox(-14.0F, -2.0F, -14.0F, 28, 7, 16);
/*  531 */     this.RJaw1.setRotationPoint(-62.0F, -115.0F, -200.0F);
/*  532 */     this.RJaw1.setTextureSize(64, 32);
/*  533 */     this.RJaw1.mirror = true;
/*  534 */     setRotation(this.RJaw1, 0.1570796F, 0.418879F, 0.0F);
/*  535 */     this.RJaw2 = new ModelRenderer(this, 900, 1700);
/*  536 */     this.RJaw2.addBox(-12.0F, -2.0F, -55.0F, 24, 6, 46);
/*  537 */     this.RJaw2.setRotationPoint(-62.0F, -115.0F, -200.0F);
/*  538 */     this.RJaw2.setTextureSize(64, 32);
/*  539 */     this.RJaw2.mirror = true;
/*  540 */     setRotation(this.RJaw2, 0.1570796F, 0.418879F, 0.0F);
/*  541 */     this.RJaw3 = new ModelRenderer(this, 900, 1765);
/*  542 */     this.RJaw3.addBox(-10.0F, -2.0F, -77.0F, 20, 6, 22);
/*  543 */     this.RJaw3.setRotationPoint(-62.0F, -115.0F, -200.0F);
/*  544 */     this.RJaw3.setTextureSize(64, 32);
/*  545 */     this.RJaw3.mirror = true;
/*  546 */     setRotation(this.RJaw3, 0.1570796F, 0.418879F, 0.0F);
/*  547 */     this.CTooth3 = new ModelRenderer(this, 70, 0);
/*  548 */     this.CTooth3.addBox(-12.0F, -8.0F, -55.0F, 2, 6, 2);
/*  549 */     this.CTooth3.setRotationPoint(0.0F, -130.0F, -201.0F);
/*  550 */     this.CTooth3.setTextureSize(64, 32);
/*  551 */     this.CTooth3.mirror = true;
/*  552 */     setRotation(this.CTooth3, -0.1047198F, 0.0F, 0.0F);
/*  553 */     this.CTooth4 = new ModelRenderer(this, 80, 0);
/*  554 */     this.CTooth4.addBox(10.0F, -8.0F, -55.0F, 2, 6, 2);
/*  555 */     this.CTooth4.setRotationPoint(0.0F, -130.0F, -201.0F);
/*  556 */     this.CTooth4.setTextureSize(64, 32);
/*  557 */     this.CTooth4.mirror = true;
/*  558 */     setRotation(this.CTooth4, -0.1047198F, 0.0F, 0.0F);
/*  559 */     this.CTooth1 = new ModelRenderer(this, 50, 0);
/*  560 */     this.CTooth1.addBox(-10.0F, -10.0F, -77.0F, 2, 8, 2);
/*  561 */     this.CTooth1.setRotationPoint(0.0F, -130.0F, -201.0F);
/*  562 */     this.CTooth1.setTextureSize(64, 32);
/*  563 */     this.CTooth1.mirror = true;
/*  564 */     setRotation(this.CTooth1, -0.1047198F, 0.0F, 0.0F);
/*  565 */     this.CTooth2 = new ModelRenderer(this, 60, 0);
/*  566 */     this.CTooth2.addBox(8.0F, -10.0F, -77.0F, 2, 8, 2);
/*  567 */     this.CTooth2.setRotationPoint(0.0F, -130.0F, -201.0F);
/*  568 */     this.CTooth2.setTextureSize(64, 32);
/*  569 */     this.CTooth2.mirror = true;
/*  570 */     setRotation(this.CTooth2, -0.1047198F, 0.0F, 0.0F);
/*  571 */     this.RTooth3 = new ModelRenderer(this, 110, 0);
/*  572 */     this.RTooth3.addBox(-12.0F, -8.0F, -55.0F, 2, 6, 2);
/*  573 */     this.RTooth3.setRotationPoint(-62.0F, -115.0F, -200.0F);
/*  574 */     this.RTooth3.setTextureSize(64, 32);
/*  575 */     this.RTooth3.mirror = true;
/*  576 */     setRotation(this.RTooth3, 0.1570796F, 0.418879F, 0.0F);
/*  577 */     this.RTooth4 = new ModelRenderer(this, 120, 0);
/*  578 */     this.RTooth4.addBox(10.0F, -8.0F, -55.0F, 2, 6, 2);
/*  579 */     this.RTooth4.setRotationPoint(-62.0F, -115.0F, -200.0F);
/*  580 */     this.RTooth4.setTextureSize(64, 32);
/*  581 */     this.RTooth4.mirror = true;
/*  582 */     setRotation(this.RTooth4, 0.1570796F, 0.418879F, 0.0F);
/*  583 */     this.RTooth1 = new ModelRenderer(this, 90, 0);
/*  584 */     this.RTooth1.addBox(-10.0F, -10.0F, -77.0F, 2, 8, 2);
/*  585 */     this.RTooth1.setRotationPoint(-62.0F, -115.0F, -200.0F);
/*  586 */     this.RTooth1.setTextureSize(64, 32);
/*  587 */     this.RTooth1.mirror = true;
/*  588 */     setRotation(this.RTooth1, 0.1570796F, 0.418879F, 0.0F);
/*  589 */     this.RTooth2 = new ModelRenderer(this, 100, 0);
/*  590 */     this.RTooth2.addBox(8.0F, -10.0F, -77.0F, 2, 8, 2);
/*  591 */     this.RTooth2.setRotationPoint(-62.0F, -115.0F, -200.0F);
/*  592 */     this.RTooth2.setTextureSize(64, 32);
/*  593 */     this.RTooth2.mirror = true;
/*  594 */     setRotation(this.RTooth2, 0.1570796F, 0.418879F, 0.0F);
/*  595 */     this.LLEye = new ModelRenderer(this, 500, 1500);
/*  596 */     this.LLEye.addBox(13.0F, -12.0F, -29.0F, 2, 6, 10);
/*  597 */     this.LLEye.setRotationPoint(59.0F, -114.0F, -195.0F);
/*  598 */     this.LLEye.setTextureSize(64, 32);
/*  599 */     this.LLEye.mirror = true;
/*  600 */     setRotation(this.LLEye, 0.1396263F, -0.3839724F, 0.0F);
/*  601 */     this.LREye = new ModelRenderer(this, 533, 1500);
/*  602 */     this.LREye.addBox(-15.0F, -12.0F, -29.0F, 2, 6, 10);
/*  603 */     this.LREye.setRotationPoint(59.0F, -114.0F, -195.0F);
/*  604 */     this.LREye.setTextureSize(64, 32);
/*  605 */     this.LREye.mirror = true;
/*  606 */     setRotation(this.LREye, 0.1396263F, -0.3839724F, 0.0F);
/*  607 */     this.CLEye = new ModelRenderer(this, 700, 1500);
/*  608 */     this.CLEye.addBox(13.0F, -12.0F, -29.0F, 2, 6, 10);
/*  609 */     this.CLEye.setRotationPoint(0.0F, -141.0F, -195.0F);
/*  610 */     this.CLEye.setTextureSize(64, 32);
/*  611 */     this.CLEye.mirror = true;
/*  612 */     setRotation(this.CLEye, -0.296706F, 0.0F, 0.0F);
/*  613 */     this.CREye = new ModelRenderer(this, 733, 1500);
/*  614 */     this.CREye.addBox(-15.0F, -12.0F, -29.0F, 2, 6, 10);
/*  615 */     this.CREye.setRotationPoint(0.0F, -141.0F, -195.0F);
/*  616 */     this.CREye.setTextureSize(64, 32);
/*  617 */     this.CREye.mirror = true;
/*  618 */     setRotation(this.CREye, -0.296706F, 0.0F, 0.0F);
/*  619 */     this.RLEye = new ModelRenderer(this, 900, 1500);
/*  620 */     this.RLEye.addBox(13.0F, -12.0F, -29.0F, 2, 6, 10);
/*  621 */     this.RLEye.setRotationPoint(-60.0F, -128.0F, -195.0F);
/*  622 */     this.RLEye.setTextureSize(64, 32);
/*  623 */     this.RLEye.mirror = true;
/*  624 */     setRotation(this.RLEye, -0.122173F, 0.418879F, 0.0F);
/*  625 */     this.RREye = new ModelRenderer(this, 933, 1500);
/*  626 */     this.RREye.addBox(-15.0F, -12.0F, -29.0F, 2, 5, 10);
/*  627 */     this.RREye.setRotationPoint(-60.0F, -128.0F, -195.0F);
/*  628 */     this.RREye.setTextureSize(64, 32);
/*  629 */     this.RREye.mirror = true;
/*  630 */     setRotation(this.RREye, -0.122173F, 0.418879F, 0.0F);
/*  631 */     this.LHeadMane = new ModelRenderer(this, 500, 1375);
/*  632 */     this.LHeadMane.addBox(0.0F, -14.0F, 0.0F, 1, 23, 19);
/*  633 */     this.LHeadMane.setRotationPoint(59.0F, -114.0F, -195.0F);
/*  634 */     this.LHeadMane.setTextureSize(64, 32);
/*  635 */     this.LHeadMane.mirror = true;
/*  636 */     setRotation(this.LHeadMane, 0.5235988F, -0.3839724F, 0.0F);
/*  637 */     this.CHeadMane = new ModelRenderer(this, 700, 1375);
/*  638 */     this.CHeadMane.addBox(0.0F, -14.0F, 0.0F, 1, 23, 19);
/*  639 */     this.CHeadMane.setRotationPoint(0.0F, -141.0F, -195.0F);
/*  640 */     this.CHeadMane.setTextureSize(64, 32);
/*  641 */     this.CHeadMane.mirror = true;
/*  642 */     setRotation(this.CHeadMane, 0.1047198F, 0.0F, 0.0F);
/*  643 */     this.RHeadMane = new ModelRenderer(this, 900, 1375);
/*  644 */     this.RHeadMane.addBox(0.0F, -14.0F, 0.0F, 1, 23, 19);
/*  645 */     this.RHeadMane.setRotationPoint(-60.0F, -128.0F, -195.0F);
/*  646 */     this.RHeadMane.setTextureSize(64, 32);
/*  647 */     this.RHeadMane.mirror = true;
/*  648 */     setRotation(this.RHeadMane, 0.3665191F, 0.418879F, 0.0F);
/*  649 */     this.LLNoseSpike = new ModelRenderer(this, 0, 300);
/*  650 */     this.LLNoseSpike.addBox(24.0F, -23.0F, -76.0F, 1, 1, 17);
/*  651 */     this.LLNoseSpike.setRotationPoint(59.0F, -114.0F, -195.0F);
/*  652 */     this.LLNoseSpike.setTextureSize(64, 32);
/*  653 */     this.LLNoseSpike.mirror = true;
/*  654 */     setRotation(this.LLNoseSpike, 0.4014257F, -0.1570796F, 0.0F);
/*  655 */     this.LRNoseSpike = new ModelRenderer(this, 0, 325);
/*  656 */     this.LRNoseSpike.addBox(-26.0F, -24.0F, -75.0F, 1, 1, 17);
/*  657 */     this.LRNoseSpike.setRotationPoint(59.0F, -114.0F, -195.0F);
/*  658 */     this.LRNoseSpike.setTextureSize(64, 32);
/*  659 */     this.LRNoseSpike.mirror = true;
/*  660 */     setRotation(this.LRNoseSpike, 0.418879F, -0.6283185F, 0.0F);
/*  661 */     this.CLNoseSpike = new ModelRenderer(this, 0, 350);
/*  662 */     this.CLNoseSpike.addBox(24.0F, -23.0F, -76.0F, 1, 1, 17);
/*  663 */     this.CLNoseSpike.setRotationPoint(0.0F, -141.0F, -195.0F);
/*  664 */     this.CLNoseSpike.setTextureSize(64, 32);
/*  665 */     this.CLNoseSpike.mirror = true;
/*  666 */     setRotation(this.CLNoseSpike, -0.0523599F, 0.2443461F, 0.0F);
/*  667 */     this.CRNoseSpike = new ModelRenderer(this, 0, 375);
/*  668 */     this.CRNoseSpike.addBox(-26.0F, -24.0F, -75.0F, 1, 1, 17);
/*  669 */     this.CRNoseSpike.setRotationPoint(0.0F, -141.0F, -195.0F);
/*  670 */     this.CRNoseSpike.setTextureSize(64, 32);
/*  671 */     this.CRNoseSpike.mirror = true;
/*  672 */     setRotation(this.CRNoseSpike, -0.0349066F, -0.2617994F, 0.0F);
/*  673 */     this.RLNoseSpike = new ModelRenderer(this, 0, 400);
/*  674 */     this.RLNoseSpike.addBox(24.0F, -23.0F, -76.0F, 1, 1, 17);
/*  675 */     this.RLNoseSpike.setRotationPoint(-60.0F, -128.0F, -195.0F);
/*  676 */     this.RLNoseSpike.setTextureSize(64, 32);
/*  677 */     this.RLNoseSpike.mirror = true;
/*  678 */     setRotation(this.RLNoseSpike, 0.1396263F, 0.6457718F, 0.0F);
/*  679 */     this.RRNoseSpike = new ModelRenderer(this, 0, 425);
/*  680 */     this.RRNoseSpike.addBox(-26.0F, -24.0F, -75.0F, 1, 1, 17);
/*  681 */     this.RRNoseSpike.setRotationPoint(-60.0F, -128.0F, -195.0F);
/*  682 */     this.RRNoseSpike.setTextureSize(64, 32);
/*  683 */     this.RRNoseSpike.mirror = true;
/*  684 */     setRotation(this.RRNoseSpike, 0.1570796F, 0.1745329F, 0.0F);
/*  685 */     this.Back1 = new ModelRenderer(this, 167, 186);
/*  686 */     this.Back1.addBox(0.0F, 0.0F, 0.0F, 30, 15, 49);
/*  687 */     this.Back1.setRotationPoint(-45.0F, -127.0F, -58.0F);
/*  688 */     this.Back1.setTextureSize(64, 32);
/*  689 */     this.Back1.mirror = true;
/*  690 */     setRotation(this.Back1, -0.0698132F, 0.0F, 0.0F);
/*  691 */     this.Back2 = new ModelRenderer(this, 0, 186);
/*  692 */     this.Back2.addBox(0.0F, 0.0F, 0.0F, 30, 15, 49);
/*  693 */     this.Back2.setRotationPoint(15.0F, -127.0F, -58.0F);
/*  694 */     this.Back2.setTextureSize(64, 32);
/*  695 */     this.Back2.mirror = true;
/*  696 */     setRotation(this.Back2, -0.0698132F, 0.0F, 0.0F);
/*  697 */     this.Lwing1 = new ModelRenderer(this, 250, 1000);
/*  698 */     this.Lwing1.addBox(0.0F, 0.0F, 0.0F, 87, 5, 5);
/*  699 */     this.Lwing1.setRotationPoint(40.0F, -121.0F, -50.0F);
/*  700 */     this.Lwing1.setTextureSize(64, 32);
/*  701 */     this.Lwing1.mirror = true;
/*  702 */     setRotation(this.Lwing1, 0.0F, 0.0349066F, 0.0F);
/*  703 */     this.Lwing2 = new ModelRenderer(this, 1220, 782);
/*  704 */     this.Lwing2.addBox(0.0F, 2.0F, 0.0F, 87, 1, 110);
/*  705 */     this.Lwing2.setRotationPoint(40.0F, -121.0F, -49.0F);
/*  706 */     this.Lwing2.setTextureSize(64, 32);
/*  707 */     this.Lwing2.mirror = true;
/*  708 */     setRotation(this.Lwing2, 0.0F, 0.0349066F, 0.0F);
/*  709 */     this.Lwing3 = new ModelRenderer(this, 250, 975);
/*  710 */     this.Lwing3.addBox(0.0F, 0.0F, 0.0F, 188, 5, 5);
/*  711 */     this.Lwing3.setRotationPoint(124.0F, -121.0F, -53.0F);
/*  712 */     this.Lwing3.setTextureSize(64, 32);
/*  713 */     this.Lwing3.mirror = true;
/*  714 */     setRotation(this.Lwing3, 0.0F, 0.0F, 0.0F);
/*  715 */     this.Lwing4 = new ModelRenderer(this, 1341, 625);
/*  716 */     this.Lwing4.addBox(0.0F, 2.0F, 0.0F, 188, 1, 147);
/*  717 */     this.Lwing4.setRotationPoint(124.0F, -121.0F, -50.0F);
/*  718 */     this.Lwing4.setTextureSize(64, 32);
/*  719 */     this.Lwing4.mirror = true;
/*  720 */     setRotation(this.Lwing4, 0.0F, 0.0F, 0.0F);
/*  721 */     this.Lwing5 = new ModelRenderer(this, 245, 950);
/*  722 */     this.Lwing5.addBox(0.0F, 0.0F, 0.0F, 87, 5, 5);
/*  723 */     this.Lwing5.setRotationPoint(309.0F, -121.0F, -53.0F);
/*  724 */     this.Lwing5.setTextureSize(64, 32);
/*  725 */     this.Lwing5.mirror = true;
/*  726 */     setRotation(this.Lwing5, 0.0F, -0.0349066F, 0.0F);
/*  727 */     this.Lwing6 = new ModelRenderer(this, 1300, 1300);
/*  728 */     this.Lwing6.addBox(0.0F, 2.0F, 1.0F, 87, 1, 125);
/*  729 */     this.Lwing6.setRotationPoint(309.0F, -121.0F, -50.0F);
/*  730 */     this.Lwing6.setTextureSize(64, 32);
/*  731 */     this.Lwing6.mirror = true;
/*  732 */     setRotation(this.Lwing6, 0.0F, 0.0F, 0.0F);
/*  733 */     this.Lwing7 = new ModelRenderer(this, 250, 900);
/*  734 */     this.Lwing7.addBox(0.0F, 0.0F, 0.0F, 150, 5, 5);
/*  735 */     this.Lwing7.setRotationPoint(124.0F, -121.0F, -53.0F);
/*  736 */     this.Lwing7.setTextureSize(64, 32);
/*  737 */     this.Lwing7.mirror = true;
/*  738 */     setRotation(this.Lwing7, 0.0F, 0.0F, 0.2617994F);
/*  739 */     this.Lwing9 = new ModelRenderer(this, 250, 925);
/*  740 */     this.Lwing9.addBox(0.0F, 0.0F, 0.0F, 175, 5, 5);
/*  741 */     this.Lwing9.setRotationPoint(124.0F, -121.0F, -53.0F);
/*  742 */     this.Lwing9.setTextureSize(64, 32);
/*  743 */     this.Lwing9.mirror = true;
/*  744 */     setRotation(this.Lwing9, 0.0F, 0.0F, -0.2617994F);
/*  745 */     this.Lwing8 = new ModelRenderer(this, 1300, 1156);
/*  746 */     this.Lwing8.addBox(0.0F, 2.0F, 0.0F, 150, 1, 120);
/*  747 */     this.Lwing8.setRotationPoint(124.0F, -121.0F, -50.0F);
/*  748 */     this.Lwing8.setTextureSize(64, 32);
/*  749 */     this.Lwing8.mirror = true;
/*  750 */     setRotation(this.Lwing8, 0.0F, 0.0F, 0.2617994F);
/*  751 */     this.Lwing10 = new ModelRenderer(this, 1392, 326);
/*  752 */     this.Lwing10.addBox(0.0F, 2.0F, 0.0F, 176, 1, 136);
/*  753 */     this.Lwing10.setRotationPoint(124.0F, -121.0F, -50.0F);
/*  754 */     this.Lwing10.setTextureSize(64, 32);
/*  755 */     this.Lwing10.mirror = true;
/*  756 */     setRotation(this.Lwing10, 0.0F, 0.0F, -0.2617994F);
/*  757 */     this.Rwing1 = new ModelRenderer(this, 650, 1000);
/*  758 */     this.Rwing1.addBox(-87.0F, 0.0F, 0.0F, 87, 5, 5);
/*  759 */     this.Rwing1.setRotationPoint(-40.0F, -121.0F, -50.0F);
/*  760 */     this.Rwing1.setTextureSize(64, 32);
/*  761 */     this.Rwing1.mirror = true;
/*  762 */     setRotation(this.Rwing1, 0.0F, -0.0349066F, 0.0F);
/*  763 */     this.Rwing2 = new ModelRenderer(this, 1619, 782);
/*  764 */     this.Rwing2.addBox(-87.0F, 2.0F, 0.0F, 87, 1, 110);
/*  765 */     this.Rwing2.setRotationPoint(-40.0F, -121.0F, -49.0F);
/*  766 */     this.Rwing2.setTextureSize(64, 32);
/*  767 */     this.Rwing2.mirror = true;
/*  768 */     setRotation(this.Rwing2, 0.0F, -0.0349066F, 0.0F);
/*  769 */     this.Rwing3 = new ModelRenderer(this, 550, 950);
/*  770 */     this.Rwing3.addBox(-188.0F, 0.0F, 0.0F, 188, 5, 5);
/*  771 */     this.Rwing3.setRotationPoint(-124.0F, -121.0F, -53.0F);
/*  772 */     this.Rwing3.setTextureSize(64, 32);
/*  773 */     this.Rwing3.mirror = true;
/*  774 */     setRotation(this.Rwing3, 0.0F, 0.0F, 0.0F);
/*  775 */     this.Rwing4 = new ModelRenderer(this, 1341, 470);
/*  776 */     this.Rwing4.addBox(-188.0F, 2.0F, 0.0F, 188, 1, 147);
/*  777 */     this.Rwing4.setRotationPoint(-124.0F, -121.0F, -53.0F);
/*  778 */     this.Rwing4.setTextureSize(64, 32);
/*  779 */     this.Rwing4.mirror = true;
/*  780 */     setRotation(this.Rwing4, 0.0F, 0.0F, 0.0F);
/*  781 */     this.Rwing5 = new ModelRenderer(this, 750, 975);
/*  782 */     this.Rwing5.addBox(-87.0F, 0.0F, 0.0F, 87, 5, 5);
/*  783 */     this.Rwing5.setRotationPoint(-309.0F, -121.0F, -53.0F);
/*  784 */     this.Rwing5.setTextureSize(64, 32);
/*  785 */     this.Rwing5.mirror = true;
/*  786 */     setRotation(this.Rwing5, 0.0F, 0.0349066F, 0.0F);
/*  787 */     this.Rwing6 = new ModelRenderer(this, 1300, 1436);
/*  788 */     this.Rwing6.addBox(-87.0F, 2.0F, 1.0F, 87, 1, 125);
/*  789 */     this.Rwing6.setRotationPoint(-309.0F, -121.0F, -50.0F);
/*  790 */     this.Rwing6.setTextureSize(64, 32);
/*  791 */     this.Rwing6.mirror = true;
/*  792 */     setRotation(this.Rwing6, 0.0F, 0.0F, 0.0F);
/*  793 */     this.Rwing7 = new ModelRenderer(this, 650, 900);
/*  794 */     this.Rwing7.addBox(-150.0F, 0.0F, 0.0F, 150, 5, 5);
/*  795 */     this.Rwing7.setRotationPoint(-124.0F, -121.0F, -53.0F);
/*  796 */     this.Rwing7.setTextureSize(64, 32);
/*  797 */     this.Rwing7.mirror = true;
/*  798 */     setRotation(this.Rwing7, 0.0F, 0.0F, -0.2617994F);
/*  799 */     this.Rwing8 = new ModelRenderer(this, 1300, 1024);
/*  800 */     this.Rwing8.addBox(-150.0F, 2.0F, 0.0F, 150, 1, 120);
/*  801 */     this.Rwing8.setRotationPoint(-124.0F, -121.0F, -53.0F);
/*  802 */     this.Rwing8.setTextureSize(64, 32);
/*  803 */     this.Rwing8.mirror = true;
/*  804 */     setRotation(this.Rwing8, 0.0F, 0.0F, -0.2617994F);
/*  805 */     this.Rwing9 = new ModelRenderer(this, 621, 925);
/*  806 */     this.Rwing9.addBox(-175.0F, 0.0F, 0.0F, 175, 5, 5);
/*  807 */     this.Rwing9.setRotationPoint(-124.0F, -121.0F, -53.0F);
/*  808 */     this.Rwing9.setTextureSize(64, 32);
/*  809 */     this.Rwing9.mirror = true;
/*  810 */     setRotation(this.Rwing9, 0.0F, 0.0F, 0.2617994F);
/*  811 */     this.Rwing10 = new ModelRenderer(this, 1391, 184);
/*  812 */     this.Rwing10.addBox(-176.0F, 2.0F, 0.0F, 176, 1, 136);
/*  813 */     this.Rwing10.setRotationPoint(-124.0F, -121.0F, -53.0F);
/*  814 */     this.Rwing10.setTextureSize(64, 32);
/*  815 */     this.Rwing10.mirror = true;
/*  816 */     setRotation(this.Rwing10, 0.0F, 0.0F, 0.2617994F);
/*  817 */     this.TailTip2 = new ModelRenderer(this, 500, 63);
/*  818 */     this.TailTip2.addBox(-35.0F, -2.0F, 36.0F, 70, 4, 26);
/*  819 */     this.TailTip2.setRotationPoint(0.0F, -86.0F, 308.0F);
/*  820 */     this.TailTip2.setTextureSize(64, 32);
/*  821 */     this.TailTip2.mirror = true;
/*  822 */     setRotation(this.TailTip2, 0.0F, 0.0F, 0.0F);
/*  823 */     this.Ridge1 = new ModelRenderer(this, 850, 717);
/*  824 */     this.Ridge1.addBox(-1.0F, 0.0F, 0.0F, 3, 10, 24);
/*  825 */     this.Ridge1.setRotationPoint(0.0F, -122.0F, -75.0F);
/*  826 */     this.Ridge1.setTextureSize(64, 32);
/*  827 */     this.Ridge1.mirror = true;
/*  828 */     setRotation(this.Ridge1, 0.3665191F, 0.0F, 0.0F);
/*  829 */     this.Ridge2 = new ModelRenderer(this, 850, 676);
/*  830 */     this.Ridge2.addBox(-1.0F, 0.0F, 0.0F, 3, 10, 24);
/*  831 */     this.Ridge2.setRotationPoint(0.0F, -122.0F, -50.0F);
/*  832 */     this.Ridge2.setTextureSize(64, 32);
/*  833 */     this.Ridge2.mirror = true;
/*  834 */     setRotation(this.Ridge2, 0.3665191F, 0.0F, 0.0F);
/*  835 */     this.Ridge3 = new ModelRenderer(this, 800, 600);
/*  836 */     this.Ridge3.addBox(-1.0F, 0.0F, 0.0F, 3, 20, 49);
/*  837 */     this.Ridge3.setRotationPoint(0.0F, -120.0F, -20.0F);
/*  838 */     this.Ridge3.setTextureSize(64, 32);
/*  839 */     this.Ridge3.mirror = true;
/*  840 */     setRotation(this.Ridge3, 0.3665191F, 0.0F, 0.0F);
/*  841 */     this.Ridge4 = new ModelRenderer(this, 800, 550);
/*  842 */     this.Ridge4.addBox(-1.0F, 3.0F, 9.0F, 3, 10, 22);
/*  843 */     this.Ridge4.setRotationPoint(0.0F, -114.0F, 29.0F);
/*  844 */     this.Ridge4.setTextureSize(64, 32);
/*  845 */     this.Ridge4.mirror = true;
/*  846 */     setRotation(this.Ridge4, 0.3665191F, 0.0F, 0.0F);
/*  847 */     this.Ridge5 = new ModelRenderer(this, 800, 500);
/*  848 */     this.Ridge5.addBox(-1.0F, 13.0F, 33.0F, 3, 10, 20);
/*  849 */     this.Ridge5.setRotationPoint(0.0F, -114.0F, 29.0F);
/*  850 */     this.Ridge5.setTextureSize(64, 32);
/*  851 */     this.Ridge5.mirror = true;
/*  852 */     setRotation(this.Ridge5, 0.3665191F, 0.0F, 0.0F);
/*  853 */     this.Ridge6 = new ModelRenderer(this, 638, 165);
/*  854 */     this.Ridge6.addBox(-1.0F, 2.0F, 20.0F, 3, 10, 20);
/*  855 */     this.Ridge6.setRotationPoint(0.0F, -87.0F, 268.0F);
/*  856 */     this.Ridge6.setTextureSize(64, 32);
/*  857 */     this.Ridge6.mirror = true;
...
/* 1217 */     model.rotateAngleX = x;
/* 1218 */     model.rotateAngleY = y;
/* 1219 */     model.rotateAngleZ = z;
/*      */   }
/*      */ 
/*      */   
/*      */   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
/* 1224 */     super.setRotationAngles(par1, par2, par3, par4, par5, par6, par7Entity);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1232 */     this.LJaw1.rotateAngleX = Ljawangle;
/* 1233 */     this.LJaw2.rotateAngleX = Ljawangle;
/* 1234 */     this.LJaw3.rotateAngleX = Ljawangle;
/* 1235 */     this.LTooth1.rotateAngleX = Ljawangle;
/* 1236 */     this.LTooth2.rotateAngleX = Ljawangle;
/* 1237 */     this.LTooth3.rotateAngleX = Ljawangle;
/* 1238 */     this.LTooth4.rotateAngleX = Ljawangle;
/*      */ 
/*      */ 
/*      */     
/* 1242 */     this.NeckL1.rotateAngleY = Lheadlr * 0.125F;
/* 1243 */     this.NeckL1.rotationPointZ -= (float)Math.cos(this.NeckL1.rotateAngleY) * 20.0F;
/* 1244 */     this.NeckL1.rotationPointX -= (float)Math.sin(this.NeckL1.rotateAngleY) * 20.0F;
/* 1245 */     this.NeckL2.rotateAngleY = Lheadlr * 0.25F;
/* 1246 */     this.NeckL2.rotationPointZ -= (float)Math.cos(this.NeckL2.rotateAngleY) * 36.0F;
/* 1247 */     this.NeckL2.rotationPointX -= (float)Math.sin(this.NeckL2.rotateAngleY) * 36.0F;
/* 1248 */     this.NeckL3.rotateAngleY = Lheadlr * 0.38F;
/* 1249 */     this.NeckL3.rotationPointZ -= (float)Math.cos(this.NeckL3.rotateAngleY) * 36.0F;
/* 1250 */     this.NeckL3.rotationPointX -= (float)Math.sin(this.NeckL3.rotateAngleY) * 36.0F;
/* 1251 */     this.NeckL4.rotateAngleY = Lheadlr * 0.5F;
/* 1252 */     this.NeckL4.rotationPointZ -= (float)Math.cos(this.NeckL4.rotateAngleY) * 36.0F;
/* 1253 */     this.NeckL4.rotationPointX -= (float)Math.sin(this.NeckL4.rotateAngleY) * 36.0F;
/* 1254 */     this.LHead1.rotateAngleY = Lheadlr;
/*      */     
/* 1256 */     this.LHead2.rotateAngleY = Lheadlr;
/* 1257 */     this.LHead2.rotationPointZ = this.LHead1.rotationPointZ;
/* 1258 */     this.LHead2.rotationPointX = this.LHead1.rotationPointX;
/* 1259 */     this.LHead3.rotateAngleY = Lheadlr;
/* 1260 */     this.LHead3.rotationPointZ = this.LHead1.rotationPointZ;
/* 1261 */     this.LHead3.rotationPointX = this.LHead1.rotationPointX;
/* 1262 */     this.LHeadMane.rotateAngleY = Lheadlr;
/* 1263 */     this.LHeadMane.rotationPointZ = this.LHead1.rotationPointZ;
/* 1264 */     this.LHeadMane.rotationPointX = this.LHead1.rotationPointX;
/* 1265 */     this.LLEye.rotateAngleY = Lheadlr;
/* 1266 */     this.LLEye.rotationPointZ = this.LHead1.rotationPointZ;
/* 1267 */     this.LLEye.rotationPointX = this.LHead1.rotationPointX;
/* 1268 */     this.LREye.rotateAngleY = Lheadlr;
/* 1269 */     this.LREye.rotationPointZ = this.LHead1.rotationPointZ;
/* 1270 */     this.LREye.rotationPointX = this.LHead1.rotationPointX;
/* 1271 */     this.LLNoseSpike.rotateAngleY = 0.244F + Lheadlr;
/* 1272 */     this.LLNoseSpike.rotationPointZ = this.LHead1.rotationPointZ;
/* 1273 */     this.LLNoseSpike.rotationPointX = this.LHead1.rotationPointX;
/* 1274 */     this.LRNoseSpike.rotateAngleY = -0.261F + Lheadlr;
/* 1275 */     this.LRNoseSpike.rotationPointZ = this.LHead1.rotationPointZ;
/* 1276 */     this.LRNoseSpike.rotationPointX = this.LHead1.rotationPointX;
/*      */ 
/*      */     
/* 1279 */     this.LJaw1.rotateAngleY = Lheadlr;
/* 1280 */     this.NeckL4.rotationPointZ -= (float)Math.cos(this.NeckL4.rotateAngleY) * 37.0F;
/* 1281 */     this.NeckL4.rotationPointX -= (float)Math.sin(this.NeckL4.rotateAngleY) * 37.0F;
/*      */     
/* 1283 */     this.LJaw2.rotateAngleY = Lheadlr;
/* 1284 */     this.LJaw2.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1285 */     this.LJaw2.rotationPointX = this.LJaw1.rotationPointX;
/* 1286 */     this.LJaw3.rotateAngleY = Lheadlr;
/* 1287 */     this.LJaw3.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1288 */     this.LJaw3.rotationPointX = this.LJaw1.rotationPointX;
/* 1289 */     this.LTooth1.rotateAngleY = Lheadlr;
/* 1290 */     this.LTooth1.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1291 */     this.LTooth1.rotationPointX = this.LJaw1.rotationPointX;
/* 1292 */     this.LTooth2.rotateAngleY = Lheadlr;
/* 1293 */     this.LTooth2.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1294 */     this.LTooth2.rotationPointX = this.LJaw1.rotationPointX;
/* 1295 */     this.LTooth3.rotateAngleY = Lheadlr;
/* 1296 */     this.LTooth3.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1297 */     this.LTooth3.rotationPointX = this.LJaw1.rotationPointX;
/* 1298 */     this.LTooth4.rotateAngleY = Lheadlr;
/* 1299 */     this.LTooth4.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1300 */     this.LTooth4.rotationPointX = this.LJaw1.rotationPointX;
/*      */ 
/*      */ 
/*      */     
/* 1304 */     this.NeckL1.rotateAngleX = Lheadud * 0.125F;
/* 1305 */     this.NeckL1.rotationPointY += (float)Math.sin(this.NeckL1.rotateAngleX) * 20.0F;
/* 1306 */     this.NeckL1.rotationPointZ += (this.NeckL2.rotationPointZ - this.NeckL1.rotationPointZ) * (float)Math.cos(this.NeckL1.rotateAngleX);
/* 1307 */     this.NeckL1.rotationPointX += (this.NeckL2.rotationPointX - this.NeckL1.rotationPointX) * (float)Math.cos(this.NeckL1.rotateAngleX);
/* 1308 */     this.NeckL2.rotateAngleX = Lheadud * 0.25F;
/* 1309 */     this.NeckL2.rotationPointY += (float)Math.sin(this.NeckL2.rotateAngleX) * 36.0F;
/* 1310 */     this.NeckL2.rotationPointZ += (this.NeckL3.rotationPointZ - this.NeckL2.rotationPointZ) * (float)Math.cos(this.NeckL2.rotateAngleX);
/* 1311 */     this.NeckL2.rotationPointX += (this.NeckL3.rotationPointX - this.NeckL2.rotationPointX) * (float)Math.cos(this.NeckL2.rotateAngleX);
/* 1312 */     this.NeckL3.rotateAngleX = Lheadud * 0.38F;
/* 1313 */     this.NeckL3.rotationPointY += (float)Math.sin(this.NeckL3.rotateAngleX) * 36.0F;
/* 1314 */     this.NeckL3.rotationPointZ += (this.NeckL4.rotationPointZ - this.NeckL3.rotationPointZ) * (float)Math.cos(this.NeckL3.rotateAngleX);
/* 1315 */     this.NeckL3.rotationPointX += (this.NeckL4.rotationPointX - this.NeckL3.rotationPointX) * (float)Math.cos(this.NeckL3.rotateAngleX);
/* 1316 */     this.NeckL4.rotateAngleX = Lheadud * 0.5F;
/* 1317 */     this.NeckL4.rotationPointY += (float)Math.sin(this.NeckL4.rotateAngleX) * 36.0F;
/* 1318 */     this.NeckL4.rotationPointZ += (this.LHead1.rotationPointZ - this.NeckL4.rotationPointZ) * (float)Math.cos(this.NeckL4.rotateAngleX);
/* 1319 */     this.NeckL4.rotationPointX += (this.LHead1.rotationPointX - this.NeckL4.rotationPointX) * (float)Math.cos(this.NeckL4.rotateAngleX);
/* 1320 */     this.LHead1.rotateAngleX = Lheadud;
/*      */     
/* 1322 */     this.LHead2.rotateAngleX = Lheadud;
/* 1323 */     this.LHead2.rotationPointZ = this.LHead1.rotationPointZ;
/* 1324 */     this.LHead2.rotationPointX = this.LHead1.rotationPointX;
/* 1325 */     this.LHead2.rotationPointY = this.LHead1.rotationPointY;
/* 1326 */     this.LHead3.rotateAngleX = Lheadud;
/* 1327 */     this.LHead3.rotationPointZ = this.LHead1.rotationPointZ;
/* 1328 */     this.LHead3.rotationPointX = this.LHead1.rotationPointX;
/* 1329 */     this.LHead3.rotationPointY = this.LHead1.rotationPointY;
/* 1330 */     this.LHeadMane.rotateAngleX = 0.384F + Lheadud;
/* 1331 */     this.LHeadMane.rotationPointZ = this.LHead1.rotationPointZ;
/* 1332 */     this.LHeadMane.rotationPointX = this.LHead1.rotationPointX;
/* 1333 */     this.LHeadMane.rotationPointY = this.LHead1.rotationPointY;
/* 1334 */     this.LLEye.rotateAngleX = Lheadud;
/* 1335 */     this.LLEye.rotationPointZ = this.LHead1.rotationPointZ;
/* 1336 */     this.LLEye.rotationPointX = this.LHead1.rotationPointX;
/* 1337 */     this.LLEye.rotationPointY = this.LHead1.rotationPointY;
/* 1338 */     this.LREye.rotateAngleX = Lheadud;
/* 1339 */     this.LREye.rotationPointZ = this.LHead1.rotationPointZ;
/* 1340 */     this.LREye.rotationPointX = this.LHead1.rotationPointX;
/* 1341 */     this.LREye.rotationPointY = this.LHead1.rotationPointY;
/* 1342 */     this.LLNoseSpike.rotateAngleX = 0.244F + Lheadud;
/* 1343 */     this.LLNoseSpike.rotationPointZ = this.LHead1.rotationPointZ;
/* 1344 */     this.LLNoseSpike.rotationPointX = this.LHead1.rotationPointX;
/* 1345 */     this.LLNoseSpike.rotationPointY = this.LHead1.rotationPointY;
/* 1346 */     this.LRNoseSpike.rotateAngleX = 0.261F + Lheadud;
/* 1347 */     this.LRNoseSpike.rotationPointZ = this.LHead1.rotationPointZ;
/* 1348 */     this.LRNoseSpike.rotationPointX = this.LHead1.rotationPointX;
/* 1349 */     this.LRNoseSpike.rotationPointY = this.LHead1.rotationPointY;
/*      */ 
/*      */     
/* 1352 */     this.LHead1.rotationPointY += (float)Math.cos(this.LHead1.rotateAngleX) * 14.0F;
/* 1353 */     this.NeckL4.rotationPointZ += (this.LJaw1.rotationPointZ - this.NeckL4.rotationPointZ) * (float)Math.cos(this.NeckL4.rotateAngleX);
/* 1354 */     this.LJaw1.rotationPointZ += (float)Math.sin(this.LHead1.rotateAngleX) * 14.0F;
/* 1355 */     this.NeckL4.rotationPointX += (this.LJaw1.rotationPointX - this.NeckL4.rotationPointX) * (float)Math.cos(this.NeckL4.rotateAngleX);
/*      */     
/* 1357 */     this.LJaw2.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1358 */     this.LJaw2.rotationPointX = this.LJaw1.rotationPointX;
/* 1359 */     this.LJaw2.rotationPointY = this.LJaw1.rotationPointY;
/* 1360 */     this.LJaw3.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1361 */     this.LJaw3.rotationPointX = this.LJaw1.rotationPointX;
/* 1362 */     this.LJaw3.rotationPointY = this.LJaw1.rotationPointY;
/* 1363 */     this.LTooth1.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1364 */     this.LTooth1.rotationPointX = this.LJaw1.rotationPointX;
/* 1365 */     this.LTooth1.rotationPointY = this.LJaw1.rotationPointY;
/* 1366 */     this.LTooth2.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1367 */     this.LTooth2.rotationPointX = this.LJaw1.rotationPointX;
/* 1368 */     this.LTooth2.rotationPointY = this.LJaw1.rotationPointY;
/* 1369 */     this.LTooth3.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1370 */     this.LTooth3.rotationPointX = this.LJaw1.rotationPointX;
/* 1371 */     this.LTooth3.rotationPointY = this.LJaw1.rotationPointY;
/* 1372 */     this.LTooth4.rotationPointZ = this.LJaw1.rotationPointZ;
/* 1373 */     this.LTooth4.rotationPointX = this.LJaw1.rotationPointX;
/* 1374 */     this.LTooth4.rotationPointY = this.LJaw1.rotationPointY;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1382 */     this.CJaw1.rotateAngleX = Cjawangle;
/* 1383 */     this.CJaw2.rotateAngleX = Cjawangle;
/* 1384 */     this.CJaw3.rotateAngleX = Cjawangle;
/* 1385 */     this.CTooth1.rotateAngleX = Cjawangle;
/* 1386 */     this.CTooth2.rotateAngleX = Cjawangle;
/* 1387 */     this.CTooth3.rotateAngleX = Cjawangle;
/* 1388 */     this.CTooth4.rotateAngleX = Cjawangle;
/*      */ 
/*      */ 
/*      */     
/* 1392 */     this.NeckC1.rotateAngleY = Cheadlr * 0.125F;
/* 1393 */     this.NeckC1.rotationPointZ -= (float)Math.cos(this.NeckC1.rotateAngleY) * 20.0F;
/* 1394 */     this.NeckC1.rotationPointX -= (float)Math.sin(this.NeckC1.rotateAngleY) * 20.0F;
/* 1395 */     this.NeckC2.rotateAngleY = Cheadlr * 0.25F;
/* 1396 */     this.NeckC2.rotationPointZ -= (float)Math.cos(this.NeckC2.rotateAngleY) * 36.0F;
/* 1397 */     this.NeckC2.rotationPointX -= (float)Math.sin(this.NeckC2.rotateAngleY) * 36.0F;
/* 1398 */     this.NeckC3.rotateAngleY = Cheadlr * 0.38F;
/* 1399 */     this.NeckC3.rotationPointZ -= (float)Math.cos(this.NeckC3.rotateAngleY) * 36.0F;
/* 1400 */     this.NeckC3.rotationPointX -= (float)Math.sin(this.NeckC3.rotateAngleY) * 36.0F;
/* 1401 */     this.NeckC4.rotateAngleY = Cheadlr * 0.5F;
/* 1402 */     this.NeckC4.rotationPointZ -= (float)Math.cos(this.NeckC4.rotateAngleY) * 36.0F;
/* 1403 */     this.NeckC4.rotationPointX -= (float)Math.sin(this.NeckC4.rotateAngleY) * 36.0F;
/* 1404 */     this.CHead1.rotateAngleY = Cheadlr;
/*      */     
/* 1406 */     this.CHead2.rotateAngleY = Cheadlr;
/* 1407 */     this.CHead2.rotationPointZ = this.CHead1.rotationPointZ;
/* 1408 */     this.CHead2.rotationPointX = this.CHead1.rotationPointX;
/* 1409 */     this.CHead3.rotateAngleY = Cheadlr;
/* 1410 */     this.CHead3.rotationPointZ = this.CHead1.rotationPointZ;
/* 1411 */     this.CHead3.rotationPointX = this.CHead1.rotationPointX;
/* 1412 */     this.CHeadMane.rotateAngleY = Cheadlr;
/* 1413 */     this.CHeadMane.rotationPointZ = this.CHead1.rotationPointZ;
/* 1414 */     this.CHeadMane.rotationPointX = this.CHead1.rotationPointX;
/* 1415 */     this.CLEye.rotateAngleY = Cheadlr;
/* 1416 */     this.CLEye.rotationPointZ = this.CHead1.rotationPointZ;
/* 1417 */     this.CLEye.rotationPointX = this.CHead1.rotationPointX;
/* 1418 */     this.CREye.rotateAngleY = Cheadlr;
/* 1419 */     this.CREye.rotationPointZ = this.CHead1.rotationPointZ;
/* 1420 */     this.CREye.rotationPointX = this.CHead1.rotationPointX;
/* 1421 */     this.CLNoseSpike.rotateAngleY = 0.244F + Cheadlr;
/* 1422 */     this.CLNoseSpike.rotationPointZ = this.CHead1.rotationPointZ;
/* 1423 */     this.CLNoseSpike.rotationPointX = this.CHead1.rotationPointX;
/* 1424 */     this.CRNoseSpike.rotateAngleY = -0.261F + Cheadlr;
/* 1425 */     this.CRNoseSpike.rotationPointZ = this.CHead1.rotationPointZ;
/* 1426 */     this.CRNoseSpike.rotationPointX = this.CHead1.rotationPointX;
/*      */ 
/*      */     
/* 1429 */     this.CJaw1.rotateAngleY = Cheadlr;
/* 1430 */     this.NeckC4.rotationPointZ -= (float)Math.cos(this.NeckC4.rotateAngleY) * 37.0F;
/* 1431 */     this.NeckC4.rotationPointX -= (float)Math.sin(this.NeckC4.rotateAngleY) * 37.0F;
/*      */     
/* 1433 */     this.CJaw2.rotateAngleY = Cheadlr;
/* 1434 */     this.CJaw2.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1435 */     this.CJaw2.rotationPointX = this.CJaw1.rotationPointX;
/* 1436 */     this.CJaw3.rotateAngleY = Cheadlr;
/* 1437 */     this.CJaw3.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1438 */     this.CJaw3.rotationPointX = this.CJaw1.rotationPointX;
/* 1439 */     this.CTooth1.rotateAngleY = Cheadlr;
/* 1440 */     this.CTooth1.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1441 */     this.CTooth1.rotationPointX = this.CJaw1.rotationPointX;
/* 1442 */     this.CTooth2.rotateAngleY = Cheadlr;
/* 1443 */     this.CTooth2.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1444 */     this.CTooth2.rotationPointX = this.CJaw1.rotationPointX;
/* 1445 */     this.CTooth3.rotateAngleY = Cheadlr;
/* 1446 */     this.CTooth3.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1447 */     this.CTooth3.rotationPointX = this.CJaw1.rotationPointX;
/* 1448 */     this.CTooth4.rotateAngleY = Cheadlr;
/* 1449 */     this.CTooth4.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1450 */     this.CTooth4.rotationPointX = this.CJaw1.rotationPointX;
/*      */ 
/*      */ 
/*      */     
/* 1454 */     this.NeckC1.rotateAngleX = Cheadud * 0.125F;
/* 1455 */     this.NeckC1.rotationPointY += (float)Math.sin(this.NeckC1.rotateAngleX) * 20.0F;
/* 1456 */     this.NeckC1.rotationPointZ += (this.NeckC2.rotationPointZ - this.NeckC1.rotationPointZ) * (float)Math.cos(this.NeckC1.rotateAngleX);
/* 1457 */     this.NeckC1.rotationPointX += (this.NeckC2.rotationPointX - this.NeckC1.rotationPointX) * (float)Math.cos(this.NeckC1.rotateAngleX);
/* 1458 */     this.NeckC2.rotateAngleX = Cheadud * 0.25F;
/* 1459 */     this.NeckC2.rotationPointY += (float)Math.sin(this.NeckC2.rotateAngleX) * 36.0F;
/* 1460 */     this.NeckC2.rotationPointZ += (this.NeckC3.rotationPointZ - this.NeckC2.rotationPointZ) * (float)Math.cos(this.NeckC2.rotateAngleX);
/* 1461 */     this.NeckC2.rotationPointX += (this.NeckC3.rotationPointX - this.NeckC2.rotationPointX) * (float)Math.cos(this.NeckC2.rotateAngleX);
/* 1462 */     this.NeckC3.rotateAngleX = Cheadud * 0.38F;
/* 1463 */     this.NeckC3.rotationPointY += (float)Math.sin(this.NeckC3.rotateAngleX) * 36.0F;
/* 1464 */     this.NeckC3.rotationPointZ += (this.NeckC4.rotationPointZ - this.NeckC3.rotationPointZ) * (float)Math.cos(this.NeckC3.rotateAngleX);
/* 1465 */     this.NeckC3.rotationPointX += (this.NeckC4.rotationPointX - this.NeckC3.rotationPointX) * (float)Math.cos(this.NeckC3.rotateAngleX);
/* 1466 */     this.NeckC4.rotateAngleX = Cheadud * 0.5F;
/* 1467 */     this.NeckC4.rotationPointY += (float)Math.sin(this.NeckC4.rotateAngleX) * 36.0F;
/* 1468 */     this.NeckC4.rotationPointZ += (this.CHead1.rotationPointZ - this.NeckC4.rotationPointZ) * (float)Math.cos(this.NeckC4.rotateAngleX);
/* 1469 */     this.NeckC4.rotationPointX += (this.CHead1.rotationPointX - this.NeckC4.rotationPointX) * (float)Math.cos(this.NeckC4.rotateAngleX);
/* 1470 */     this.CHead1.rotateAngleX = Cheadud;
/*      */     
/* 1472 */     this.CHead2.rotateAngleX = Cheadud;
/* 1473 */     this.CHead2.rotationPointZ = this.CHead1.rotationPointZ;
/* 1474 */     this.CHead2.rotationPointX = this.CHead1.rotationPointX;
/* 1475 */     this.CHead2.rotationPointY = this.CHead1.rotationPointY;
/* 1476 */     this.CHead3.rotateAngleX = Cheadud;
/* 1477 */     this.CHead3.rotationPointZ = this.CHead1.rotationPointZ;
/* 1478 */     this.CHead3.rotationPointX = this.CHead1.rotationPointX;
/* 1479 */     this.CHead3.rotationPointY = this.CHead1.rotationPointY;
/* 1480 */     this.CHeadMane.rotateAngleX = 0.384F + Cheadud;
/* 1481 */     this.CHeadMane.rotationPointZ = this.CHead1.rotationPointZ;
/* 1482 */     this.CHeadMane.rotationPointX = this.CHead1.rotationPointX;
/* 1483 */     this.CHeadMane.rotationPointY = this.CHead1.rotationPointY;
/* 1484 */     this.CLEye.rotateAngleX = Cheadud;
/* 1485 */     this.CLEye.rotationPointZ = this.CHead1.rotationPointZ;
/* 1486 */     this.CLEye.rotationPointX = this.CHead1.rotationPointX;
/* 1487 */     this.CLEye.rotationPointY = this.CHead1.rotationPointY;
/* 1488 */     this.CREye.rotateAngleX = Cheadud;
/* 1489 */     this.CREye.rotationPointZ = this.CHead1.rotationPointZ;
/* 1490 */     this.CREye.rotationPointX = this.CHead1.rotationPointX;
/* 1491 */     this.CREye.rotationPointY = this.CHead1.rotationPointY;
/* 1492 */     this.CLNoseSpike.rotateAngleX = 0.244F + Cheadud;
/* 1493 */     this.CLNoseSpike.rotationPointZ = this.CHead1.rotationPointZ;
/* 1494 */     this.CLNoseSpike.rotationPointX = this.CHead1.rotationPointX;
/* 1495 */     this.CLNoseSpike.rotationPointY = this.CHead1.rotationPointY;
/* 1496 */     this.CRNoseSpike.rotateAngleX = 0.261F + Cheadud;
/* 1497 */     this.CRNoseSpike.rotationPointZ = this.CHead1.rotationPointZ;
/* 1498 */     this.CRNoseSpike.rotationPointX = this.CHead1.rotationPointX;
/* 1499 */     this.CRNoseSpike.rotationPointY = this.CHead1.rotationPointY;
/*      */ 
/*      */     
/* 1502 */     this.CHead1.rotationPointY += (float)Math.cos(this.CHead1.rotateAngleX) * 14.0F;
/* 1503 */     this.NeckC4.rotationPointZ += (this.CJaw1.rotationPointZ - this.NeckC4.rotationPointZ) * (float)Math.cos(this.NeckC4.rotateAngleX);
/* 1504 */     this.CJaw1.rotationPointZ += (float)Math.sin(this.CHead1.rotateAngleX) * 14.0F;
/* 1505 */     this.NeckC4.rotationPointX += (this.CJaw1.rotationPointX - this.NeckC4.rotationPointX) * (float)Math.cos(this.NeckC4.rotateAngleX);
/*      */     
/* 1507 */     this.CJaw2.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1508 */     this.CJaw2.rotationPointX = this.CJaw1.rotationPointX;
/* 1509 */     this.CJaw2.rotationPointY = this.CJaw1.rotationPointY;
/* 1510 */     this.CJaw3.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1511 */     this.CJaw3.rotationPointX = this.CJaw1.rotationPointX;
/* 1512 */     this.CJaw3.rotationPointY = this.CJaw1.rotationPointY;
/* 1513 */     this.CTooth1.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1514 */     this.CTooth1.rotationPointX = this.CJaw1.rotationPointX;
/* 1515 */     this.CTooth1.rotationPointY = this.CJaw1.rotationPointY;
/* 1516 */     this.CTooth2.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1517 */     this.CTooth2.rotationPointX = this.CJaw1.rotationPointX;
/* 1518 */     this.CTooth2.rotationPointY = this.CJaw1.rotationPointY;
/* 1519 */     this.CTooth3.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1520 */     this.CTooth3.rotationPointX = this.CJaw1.rotationPointX;
/* 1521 */     this.CTooth3.rotationPointY = this.CJaw1.rotationPointY;
/* 1522 */     this.CTooth4.rotationPointZ = this.CJaw1.rotationPointZ;
/* 1523 */     this.CTooth4.rotationPointX = this.CJaw1.rotationPointX;
/* 1524 */     this.CTooth4.rotationPointY = this.CJaw1.rotationPointY;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1532 */     this.RJaw1.rotateAngleX = Rjawangle;
/* 1533 */     this.RJaw2.rotateAngleX = Rjawangle;
/* 1534 */     this.RJaw3.rotateAngleX = Rjawangle;
/* 1535 */     this.RTooth1.rotateAngleX = Rjawangle;
/* 1536 */     this.RTooth2.rotateAngleX = Rjawangle;
/* 1537 */     this.RTooth3.rotateAngleX = Rjawangle;
/* 1538 */     this.RTooth4.rotateAngleX = Rjawangle;
/*      */ 
/*      */ 
/*      */     
/* 1542 */     this.NeckR1.rotateAngleY = Rheadlr * 0.125F;
/* 1543 */     this.NeckR1.rotationPointZ -= (float)Math.cos(this.NeckR1.rotateAngleY) * 20.0F;
/* 1544 */     this.NeckR1.rotationPointX -= (float)Math.sin(this.NeckR1.rotateAngleY) * 20.0F;
/* 1545 */     this.NeckR2.rotateAngleY = Rheadlr * 0.25F;
/* 1546 */     this.NeckR2.rotationPointZ -= (float)Math.cos(this.NeckR2.rotateAngleY) * 36.0F;
/* 1547 */     this.NeckR2.rotationPointX -= (float)Math.sin(this.NeckR2.rotateAngleY) * 36.0F;
/* 1548 */     this.NeckR3.rotateAngleY = Rheadlr * 0.38F;
/* 1549 */     this.NeckR3.rotationPointZ -= (float)Math.cos(this.NeckR3.rotateAngleY) * 36.0F;
/* 1550 */     this.NeckR3.rotationPointX -= (float)Math.sin(this.NeckR3.rotateAngleY) * 36.0F;
/* 1551 */     this.NeckR4.rotateAngleY = Rheadlr * 0.5F;
/* 1552 */     this.NeckR4.rotationPointZ -= (float)Math.cos(this.NeckR4.rotateAngleY) * 36.0F;
/* 1553 */     this.NeckR4.rotationPointX -= (float)Math.sin(this.NeckR4.rotateAngleY) * 36.0F;
/* 1554 */     this.RHead1.rotateAngleY = Rheadlr;
/*      */     
/* 1556 */     this.RHead2.rotateAngleY = Rheadlr;
/* 1557 */     this.RHead2.rotationPointZ = this.RHead1.rotationPointZ;
/* 1558 */     this.RHead2.rotationPointX = this.RHead1.rotationPointX;
/* 1559 */     this.RHead3.rotateAngleY = Rheadlr;
/* 1560 */     this.RHead3.rotationPointZ = this.RHead1.rotationPointZ;
/* 1561 */     this.RHead3.rotationPointX = this.RHead1.rotationPointX;
/* 1562 */     this.RHeadMane.rotateAngleY = Rheadlr;
/* 1563 */     this.RHeadMane.rotationPointZ = this.RHead1.rotationPointZ;
/* 1564 */     this.RHeadMane.rotationPointX = this.RHead1.rotationPointX;
/* 1565 */     this.RLEye.rotateAngleY = Rheadlr;
/* 1566 */     this.RLEye.rotationPointZ = this.RHead1.rotationPointZ;
/* 1567 */     this.RLEye.rotationPointX = this.RHead1.rotationPointX;
/* 1568 */     this.RREye.rotateAngleY = Rheadlr;
/* 1569 */     this.RREye.rotationPointZ = this.RHead1.rotationPointZ;
/* 1570 */     this.RREye.rotationPointX = this.RHead1.rotationPointX;
/* 1571 */     this.RLNoseSpike.rotateAngleY = 0.244F + Rheadlr;
/* 1572 */     this.RLNoseSpike.rotationPointZ = this.RHead1.rotationPointZ;
/* 1573 */     this.RLNoseSpike.rotationPointX = this.RHead1.rotationPointX;
/* 1574 */     this.RRNoseSpike.rotateAngleY = -0.261F + Rheadlr;
/* 1575 */     this.RRNoseSpike.rotationPointZ = this.RHead1.rotationPointZ;
/* 1576 */     this.RRNoseSpike.rotationPointX = this.RHead1.rotationPointX;
/*      */ 
/*      */     
/* 1579 */     this.RJaw1.rotateAngleY = Rheadlr;
/* 1580 */     this.NeckR4.rotationPointZ -= (float)Math.cos(this.NeckR4.rotateAngleY) * 37.0F;
/* 1581 */     this.NeckR4.rotationPointX -= (float)Math.sin(this.NeckR4.rotateAngleY) * 37.0F;
/*      */     
/* 1583 */     this.RJaw2.rotateAngleY = Rheadlr;
/* 1584 */     this.RJaw2.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1585 */     this.RJaw2.rotationPointX = this.RJaw1.rotationPointX;
/* 1586 */     this.RJaw3.rotateAngleY = Rheadlr;
/* 1587 */     this.RJaw3.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1588 */     this.RJaw3.rotationPointX = this.RJaw1.rotationPointX;
/* 1589 */     this.RTooth1.rotateAngleY = Rheadlr;
/* 1590 */     this.RTooth1.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1591 */     this.RTooth1.rotationPointX = this.RJaw1.rotationPointX;
/* 1592 */     this.RTooth2.rotateAngleY = Rheadlr;
/* 1593 */     this.RTooth2.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1594 */     this.RTooth2.rotationPointX = this.RJaw1.rotationPointX;
/* 1595 */     this.RTooth3.rotateAngleY = Rheadlr;
/* 1596 */     this.RTooth3.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1597 */     this.RTooth3.rotationPointX = this.RJaw1.rotationPointX;
/* 1598 */     this.RTooth4.rotateAngleY = Rheadlr;
/* 1599 */     this.RTooth4.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1600 */     this.RTooth4.rotationPointX = this.RJaw1.rotationPointX;
/*      */ 
/*      */ 
/*      */     
/* 1604 */     this.NeckR1.rotateAngleX = Rheadud * 0.125F;
/* 1605 */     this.NeckR1.rotationPointY += (float)Math.sin(this.NeckR1.rotateAngleX) * 20.0F;
/* 1606 */     this.NeckR1.rotationPointZ += (this.NeckR2.rotationPointZ - this.NeckR1.rotationPointZ) * (float)Math.cos(this.NeckR1.rotateAngleX);
/* 1607 */     this.NeckR1.rotationPointX += (this.NeckR2.rotationPointX - this.NeckR1.rotationPointX) * (float)Math.cos(this.NeckR1.rotateAngleX);
/* 1608 */     this.NeckR2.rotateAngleX = Rheadud * 0.25F;
/* 1609 */     this.NeckR2.rotationPointY += (float)Math.sin(this.NeckR2.rotateAngleX) * 36.0F;
/* 1610 */     this.NeckR2.rotationPointZ += (this.NeckR3.rotationPointZ - this.NeckR2.rotationPointZ) * (float)Math.cos(this.NeckR2.rotateAngleX);
/* 1611 */     this.NeckR2.rotationPointX += (this.NeckR3.rotationPointX - this.NeckR2.rotationPointX) * (float)Math.cos(this.NeckR2.rotateAngleX);
/* 1612 */     this.NeckR3.rotateAngleX = Rheadud * 0.38F;
/* 1613 */     this.NeckR3.rotationPointY += (float)Math.sin(this.NeckR3.rotateAngleX) * 36.0F;
/* 1614 */     this.NeckR3.rotationPointZ += (this.NeckR4.rotationPointZ - this.NeckR3.rotationPointZ) * (float)Math.cos(this.NeckR3.rotateAngleX);
/* 1615 */     this.NeckR3.rotationPointX += (this.NeckR4.rotationPointX - this.NeckR3.rotationPointX) * (float)Math.cos(this.NeckR3.rotateAngleX);
/* 1616 */     this.NeckR4.rotateAngleX = Rheadud * 0.5F;
/* 1617 */     this.NeckR4.rotationPointY += (float)Math.sin(this.NeckR4.rotateAngleX) * 36.0F;
/* 1618 */     this.NeckR4.rotationPointZ += (this.RHead1.rotationPointZ - this.NeckR4.rotationPointZ) * (float)Math.cos(this.NeckR4.rotateAngleX);
/* 1619 */     this.NeckR4.rotationPointX += (this.RHead1.rotationPointX - this.NeckR4.rotationPointX) * (float)Math.cos(this.NeckR4.rotateAngleX);
/* 1620 */     this.RHead1.rotateAngleX = Rheadud;
/*      */     
/* 1622 */     this.RHead2.rotateAngleX = Rheadud;
/* 1623 */     this.RHead2.rotationPointZ = this.RHead1.rotationPointZ;
/* 1624 */     this.RHead2.rotationPointX = this.RHead1.rotationPointX;
/* 1625 */     this.RHead2.rotationPointY = this.RHead1.rotationPointY;
/* 1626 */     this.RHead3.rotateAngleX = Rheadud;
/* 1627 */     this.RHead3.rotationPointZ = this.RHead1.rotationPointZ;
/* 1628 */     this.RHead3.rotationPointX = this.RHead1.rotationPointX;
/* 1629 */     this.RHead3.rotationPointY = this.RHead1.rotationPointY;
/* 1630 */     this.RHeadMane.rotateAngleX = 0.384F + Rheadud;
/* 1631 */     this.RHeadMane.rotationPointZ = this.RHead1.rotationPointZ;
/* 1632 */     this.RHeadMane.rotationPointX = this.RHead1.rotationPointX;
/* 1633 */     this.RHeadMane.rotationPointY = this.RHead1.rotationPointY;
/* 1634 */     this.RLEye.rotateAngleX = Rheadud;
/* 1635 */     this.RLEye.rotationPointZ = this.RHead1.rotationPointZ;
/* 1636 */     this.RLEye.rotationPointX = this.RHead1.rotationPointX;
/* 1637 */     this.RLEye.rotationPointY = this.RHead1.rotationPointY;
/* 1638 */     this.RREye.rotateAngleX = Rheadud;
/* 1639 */     this.RREye.rotationPointZ = this.RHead1.rotationPointZ;
/* 1640 */     this.RREye.rotationPointX = this.RHead1.rotationPointX;
/* 1641 */     this.RREye.rotationPointY = this.RHead1.rotationPointY;
/* 1642 */     this.RLNoseSpike.rotateAngleX = 0.244F + Rheadud;
/* 1643 */     this.RLNoseSpike.rotationPointZ = this.RHead1.rotationPointZ;
/* 1644 */     this.RLNoseSpike.rotationPointX = this.RHead1.rotationPointX;
/* 1645 */     this.RLNoseSpike.rotationPointY = this.RHead1.rotationPointY;
/* 1646 */     this.RRNoseSpike.rotateAngleX = 0.261F + Rheadud;
/* 1647 */     this.RRNoseSpike.rotationPointZ = this.RHead1.rotationPointZ;
/* 1648 */     this.RRNoseSpike.rotationPointX = this.RHead1.rotationPointX;
/* 1649 */     this.RRNoseSpike.rotationPointY = this.RHead1.rotationPointY;
/*      */ 
/*      */     
/* 1652 */     this.RHead1.rotationPointY += (float)Math.cos(this.RHead1.rotateAngleX) * 14.0F;
/* 1653 */     this.NeckR4.rotationPointZ += (this.RJaw1.rotationPointZ - this.NeckR4.rotationPointZ) * (float)Math.cos(this.NeckR4.rotateAngleX);
/* 1654 */     this.RJaw1.rotationPointZ += (float)Math.sin(this.RHead1.rotateAngleX) * 14.0F;
/* 1655 */     this.NeckR4.rotationPointX += (this.RJaw1.rotationPointX - this.NeckR4.rotationPointX) * (float)Math.cos(this.NeckR4.rotateAngleX);
/*      */     
/* 1657 */     this.RJaw2.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1658 */     this.RJaw2.rotationPointX = this.RJaw1.rotationPointX;
/* 1659 */     this.RJaw2.rotationPointY = this.RJaw1.rotationPointY;
/* 1660 */     this.RJaw3.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1661 */     this.RJaw3.rotationPointX = this.RJaw1.rotationPointX;
/* 1662 */     this.RJaw3.rotationPointY = this.RJaw1.rotationPointY;
/* 1663 */     this.RTooth1.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1664 */     this.RTooth1.rotationPointX = this.RJaw1.rotationPointX;
/* 1665 */     this.RTooth1.rotationPointY = this.RJaw1.rotationPointY;
/* 1666 */     this.RTooth2.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1667 */     this.RTooth2.rotationPointX = this.RJaw1.rotationPointX;
/* 1668 */     this.RTooth2.rotationPointY = this.RJaw1.rotationPointY;
/* 1669 */     this.RTooth3.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1670 */     this.RTooth3.rotationPointX = this.RJaw1.rotationPointX;
/* 1671 */     this.RTooth3.rotationPointY = this.RJaw1.rotationPointY;
/* 1672 */     this.RTooth4.rotationPointZ = this.RJaw1.rotationPointZ;
/* 1673 */     this.RTooth4.rotationPointX = this.RJaw1.rotationPointX;
/* 1674 */     this.RTooth4.rotationPointY = this.RJaw1.rotationPointY;
/*      */   }
/*      */ }


/* Location:              C:\Users\Admin\Downloads\orespawn-1.7.10-20.3-deobf.jar!\danger\orespawn\ModelTheKing.class
