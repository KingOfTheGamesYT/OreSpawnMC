...
/* 160 */     super.render(entity, f, f1, f2, f3, f4, f5);
/* 161 */     setRotationAngles(f, f1, f2, f3, f4, f5, entity);
/*     */ 
/*     */     
/* 164 */     this.llegtop1.rotateAngleX = MathHelper.cos(f2 * 2.7F) * 3.1415927F * 0.45F * f1;
/* 165 */     this.llegbot1.rotateAngleX = this.llegtop1.rotateAngleX;
/* 166 */     this.rlegtop2.rotateAngleX = this.llegtop1.rotateAngleX;
/* 167 */     this.rlegbot2.rotateAngleX = this.llegtop1.rotateAngleX;
/* 168 */     this.rlegtop3.rotateAngleX = this.llegtop1.rotateAngleX;
/* 169 */     this.rlegbot3.rotateAngleX = this.llegtop1.rotateAngleX;
/*     */     
/* 171 */     this.rlegtop1.rotateAngleX = -this.llegtop1.rotateAngleX;
/* 172 */     this.rlegbot1.rotateAngleX = -this.llegtop1.rotateAngleX;
/* 173 */     this.llegtop2.rotateAngleX = -this.llegtop1.rotateAngleX;
/* 174 */     this.llegbot2.rotateAngleX = -this.llegtop1.rotateAngleX;
/* 175 */     this.llegtop3.rotateAngleX = -this.llegtop1.rotateAngleX;
/* 176 */     this.llegbot3.rotateAngleX = -this.llegtop1.rotateAngleX;
/*     */     
/* 178 */     this.jawsl.rotateAngleY = MathHelper.cos(f2 * 0.4F) * 3.1415927F * 0.05F;
/* 179 */     this.jawsr.rotateAngleY = -this.jawsl.rotateAngleY;
/*     */     
/* 181 */     this.thorax.render(f5);
/* 182 */     this.thorax1.render(f5);
/* 183 */     this.thorax3.render(f5);
/* 184 */     this.abdomen.render(f5);
/* 185 */     this.abdomen1.render(f5);
/* 186 */     this.head.render(f5);
/* 187 */     this.jawsr.render(f5);
/* 188 */     this.jawsl.render(f5);
/* 189 */     this.llegtop1.render(f5);
/* 190 */     this.llegbot1.render(f5);
/* 191 */     this.llegtop2.render(f5);
/* 192 */     this.llegbot2.render(f5);
/* 193 */     this.llegtop3.render(f5);
/* 194 */     this.llegbot3.render(f5);
/* 195 */     this.rlegtop1.render(f5);
/* 196 */     this.rlegbot1.render(f5);
/* 197 */     this.rlegtop2.render(f5);
/* 198 */     this.rlegbot2.render(f5);
/* 199 */     this.rlegtop3.render(f5);
/* 200 */     this.rlegbot3.render(f5);
/*     */   }
/*     */ 
/*     */   
/*     */   private void setRotation(ModelRenderer model, float x, float y, float z) {
/* 205 */     model.rotateAngleX = x;
/* 206 */     model.rotateAngleY = y;
/* 207 */     model.rotateAngleZ = z;
/*     */   }
/*     */ 
/*     */   
/*     */   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
/* 212 */     super.setRotationAngles(par1, par2, par3, par4, par5, par6, par7Entity);
/*     */   }
/*     */ }


/* Location:              C:\Users\Admin\Downloads\orespawn-1.7.10-20.3-deobf.jar!\danger\orespawn\ModelAnt.class
