...
/*  28 */     this.head.addBox(-1.5F, -12.0F, -1.5F, 3, 12, 3);
/*  29 */     this.head.setRotationPoint(0.0F, 1.0F, 0.0F);
/*  30 */     this.head.setTextureSize(64, 32);
/*  31 */     this.head.mirror = true;
/*  32 */     setRotation(this.head, 0.0F, 0.0F, 0.0F);
/*  33 */     this.body = new ModelRenderer(this, 37, 0);
/*  34 */     this.body.addBox(-1.5F, -12.0F, -1.5F, 3, 12, 3);
/*  35 */     this.body.setRotationPoint(0.0F, 13.0F, 0.0F);
...
/*  40 */     this.tail.addBox(-1.5F, -12.0F, -1.5F, 3, 12, 3);
/*  41 */     this.tail.setRotationPoint(0.0F, 25.0F, 0.0F);
...
/*  46 */     this.tooth1.addBox(-0.5F, -3.0F, -0.5F, 1, 3, 1);
/*  47 */     this.tooth1.setRotationPoint(1.0F, -11.0F, 0.0F);
/*  48 */     this.tooth1.setTextureSize(64, 32);
/*  49 */     this.tooth1.mirror = true;
/*  50 */     setRotation(this.tooth1, 0.0F, 0.0F, 0.0F);
/*  51 */     this.tooth2 = new ModelRenderer(this, 5, 0);
/*  52 */     this.tooth2.addBox(-0.5F, -3.0F, -0.5F, 1, 3, 1);
/*  53 */     this.tooth2.setRotationPoint(-1.0F, -11.0F, 0.0F);
/*  54 */     this.tooth2.setTextureSize(64, 32);
/*  55 */     this.tooth2.mirror = true;
/*  56 */     setRotation(this.tooth2, 0.0F, 0.0F, 0.0F);
/*  57 */     this.tooth3 = new ModelRenderer(this, 0, 0);
/*  58 */     this.tooth3.addBox(-0.5F, -3.0F, -0.5F, 1, 3, 1);
/*  59 */     this.tooth3.setRotationPoint(0.0F, -11.0F, 1.0F);
/*  60 */     this.tooth3.setTextureSize(64, 32);
/*  61 */     this.tooth3.mirror = true;
/*  62 */     setRotation(this.tooth3, 0.0F, 0.0F, 0.0F);
/*  63 */     this.tooth4 = new ModelRenderer(this, 10, 0);
/*  64 */     this.tooth4.addBox(-0.5F, -3.0F, -0.5F, 1, 3, 1);
/*  65 */     this.tooth4.setRotationPoint(0.0F, -11.0F, -1.0F);
/*  66 */     this.tooth4.setTextureSize(64, 32);
/*  67 */     this.tooth4.mirror = true;
/*  68 */     setRotation(this.tooth4, 0.0F, 0.0F, 0.0F);
/*  69 */     this.head2 = new ModelRenderer(this, 0, 6);
/*  70 */     this.head2.addBox(-2.0F, -8.0F, -2.0F, 4, 8, 4);
/*  71 */     this.head2.setRotationPoint(0.0F, 0.0F, 0.0F);
/*  72 */     this.head2.setTextureSize(64, 32);
/*  73 */     this.head2.mirror = true;
...
/*     */     //   0	966	0	this	Ldanger/orespawn/entity/model/ModelWormMedium;
...
/* 153 */     super.setRotationAngles(par1, par2, par3, par4, par5, par6, par7Entity);
/*     */   }
/*     */ }


/* Location:              C:\Users\Admin\Downloads\orespawnmc_1.12-development_0.8-deobf.jar!\danger\orespawn\entity\model\ModelWormMedium.class
