...
/*  33 */     this.tail.addBox(-3.0F, 0.0F, 0.0F, 6, 9, 7);
/*  34 */     this.tail.setRotationPoint(0.0F, 8.0F, 1.0F);
/*  35 */     this.tail.setTextureSize(64, 32);
/*  36 */     this.tail.mirror = true;
/*  37 */     setRotation(this.tail, 0.8922867F, 0.0F, 0.0F);
/*  38 */     this.body = new ModelRenderer(this, 0, 13);
/*  39 */     this.body.addBox(-4.0F, 0.0F, 0.0F, 8, 10, 9);
/*  40 */     this.body.setRotationPoint(0.0F, 5.0F, -3.0F);
/*  41 */     this.body.setTextureSize(64, 32);
/*  42 */     this.body.mirror = true;
/*  43 */     setRotation(this.body, 0.3346075F, 0.0F, 0.0F);
/*  44 */     this.neck1 = new ModelRenderer(this, 48, 0);
/*  45 */     this.neck1.addBox(-2.0F, 0.0F, 0.0F, 4, 5, 4);
/*  46 */     this.neck1.setRotationPoint(0.0F, 4.0F, -1.0F);
/*  47 */     this.neck1.setTextureSize(64, 32);
/*  48 */     this.neck1.mirror = true;
/*  49 */     setRotation(this.neck1, -1.189716F, 0.0F, 0.0F);
/*  50 */     this.neck = new ModelRenderer(this, 38, 0);
/*  51 */     this.neck.addBox(-1.0F, 0.0F, 0.0F, 2, 7, 2);
/*  52 */     this.neck.setRotationPoint(0.0F, 8.0F, -3.0F);
/*  53 */     this.neck.setTextureSize(64, 32);
/*  54 */     this.neck.mirror = true;
/*  55 */     setRotation(this.neck, -2.806985F, 0.0F, 0.0F);
/*  56 */     this.head = new ModelRenderer(this, 24, 0);
/*  57 */     this.head.addBox(-1.0F, -2.0F, -3.0F, 2, 2, 4);
/*  58 */     this.head.setRotationPoint(0.0F, 2.0F, -6.0F);
/*  59 */     this.head.setTextureSize(64, 32);
/*  60 */     this.head.mirror = true;
/*  61 */     setRotation(this.head, 0.0371786F, 0.0F, 0.0F);
/*  62 */     this.beak = new ModelRenderer(this, 28, 7);
/*  63 */     this.beak.addBox(-0.5F, 0.0F, 3.0F, 1, 1, 3);
/*  64 */     this.beak.setRotationPoint(0.0F, 2.0F, -6.0F);
/*  65 */     this.beak.setTextureSize(64, 32);
/*  66 */     this.beak.mirror = true;
/*  67 */     setRotation(this.beak, -3.104414F, 0.0F, 0.0F);
/*  68 */     this.leg1 = new ModelRenderer(this, 0, 0);
/*  69 */     this.leg1.addBox(-0.5F, 0.0F, -1.0F, 1, 11, 2);
/*  70 */     this.leg1.setRotationPoint(3.0F, 12.0F, 3.0F);
/*  71 */     this.leg1.setTextureSize(64, 32);
/*  72 */     this.leg1.mirror = true;
/*  73 */     setRotation(this.leg1, 0.0F, 0.0F, 0.0F);
/*  74 */     this.leg2 = new ModelRenderer(this, 0, 0);
/*  75 */     this.leg2.addBox(-0.5F, 0.0F, -1.0F, 1, 11, 2);
/*  76 */     this.leg2.setRotationPoint(-3.0F, 12.0F, 3.0F);
/*  77 */     this.leg2.setTextureSize(64, 32);
/*  78 */     this.leg2.mirror = true;
/*  79 */     setRotation(this.leg2, 0.0F, 0.0F, 0.0F);
/*  80 */     this.crest = new ModelRenderer(this, 10, 0);
/*  81 */     this.crest.addBox(-0.5F, -4.0F, 1.0F, 1, 4, 5);
/*  82 */     this.crest.setRotationPoint(0.0F, 2.0F, -6.0F);
/*  83 */     this.crest.setTextureSize(64, 32);
/*  84 */     this.crest.mirror = true;
/*  85 */     setRotation(this.crest, 1.710216F, 0.0F, 0.0F);
/*  86 */     this.foot1 = new ModelRenderer(this, 47, 10);
/*  87 */     this.foot1.addBox(-1.033333F, 11.0F, -2.0F, 2, 1, 3);
/*  88 */     this.foot1.setRotationPoint(-3.0F, 12.0F, 3.0F);
/*  89 */     this.foot1.setTextureSize(64, 32);
/*  90 */     this.foot1.mirror = true;
/*  91 */     setRotation(this.foot1, 0.0F, 0.0F, 0.0F);
/*  92 */     this.foot2 = new ModelRenderer(this, 47, 10);
/*  93 */     this.foot2.addBox(-1.0F, 11.0F, -2.0F, 2, 1, 3);
/*  94 */     this.foot2.setRotationPoint(3.0F, 12.0F, 3.0F);
/*  95 */     this.foot2.setTextureSize(64, 32);
/*  96 */     this.foot2.mirror = true;
/*  97 */     setRotation(this.foot2, 0.0F, 0.0F, 0.0F);
/*  98 */     this.gobbler = new ModelRenderer(this, 38, 10);
/*  99 */     this.gobbler.addBox(-0.5F, -1.0F, -2.5F, 1, 5, 1);
/* 100 */     this.gobbler.setRotationPoint(0.0F, 8.0F, -3.0F);
/* 101 */     this.gobbler.setTextureSize(64, 32);
/* 102 */     this.gobbler.mirror = true;
...
/*     */     // Byte code:
/*     */     //   0: aload_1
/*     */     //   1: checkcast danger/orespawn/entity/Cassowary
/*     */     //   4: astore #8
/*     */     //   6: aload_0
/*     */     //   7: aload_1
/*     */     //   8: fload_2
...
/*     */     //   0	359	0	this	Ldanger/orespawn/entity/model/ModelCassowary;
...
/*     */     //   0	359	6	f4	F
/*     */     //   0	359	7	f5	F
/*     */     //   6	353	8	e	Ldanger/orespawn/entity/Cassowary;
/*     */     //   39	320	9	newangle	F
...
/* 156 */     super.setRotationAngles(par1, par2, par3, par4, par5, par6, par7Entity);
/*     */   }
/*     */ }


/* Location:              C:\Users\Admin\Downloads\orespawnmc_1.12-development_0.8-deobf.jar!\danger\orespawn\entity\model\ModelCassowary.class
