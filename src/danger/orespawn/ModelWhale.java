...
/*  33 */     this.textureHeight = 256;
/*     */     
/*  35 */     this.belly = new ModelRenderer(this, 0, 92);
/*  36 */     this.belly.addBox(-6.0F, 0.0F, 0.0F, 12, 2, 32);
/*  37 */     this.belly.setRotationPoint(0.0F, 22.0F, 6.0F);
/*  38 */     this.belly.setTextureSize(256, 256);
/*  39 */     this.belly.mirror = true;
/*  40 */     setRotation(this.belly, 0.0F, 0.0F, 0.0F);
/*  41 */     this.body = new ModelRenderer(this, 0, 188);
/*  42 */     this.body.addBox(-10.0F, 0.0F, 0.0F, 20, 12, 52);
/*  43 */     this.body.setRotationPoint(0.0F, 10.0F, 0.0F);
/*  44 */     this.body.setTextureSize(256, 256);
/*  45 */     this.body.mirror = true;
/*  46 */     setRotation(this.body, 0.0F, 0.0F, 0.0F);
/*  47 */     this.back = new ModelRenderer(this, 0, 45);
/*  48 */     this.back.addBox(-4.0F, 0.0F, 0.0F, 8, 2, 40);
/*  49 */     this.back.setRotationPoint(0.0F, 8.0F, 3.0F);
/*  50 */     this.back.setTextureSize(256, 256);
/*  51 */     this.back.mirror = true;
/*  52 */     setRotation(this.back, 0.0F, 0.0F, 0.0F);
/*  53 */     this.tail1 = new ModelRenderer(this, 186, 0);
/*  54 */     this.tail1.addBox(-6.0F, 0.0F, 0.0F, 12, 7, 14);
/*  55 */     this.tail1.setRotationPoint(0.0F, 11.0F, 52.0F);
/*  56 */     this.tail1.setTextureSize(256, 256);
/*  57 */     this.tail1.mirror = true;
/*  58 */     setRotation(this.tail1, 0.0F, 0.0F, 0.0F);
/*  59 */     this.tail2 = new ModelRenderer(this, 186, 24);
/*  60 */     this.tail2.addBox(-4.0F, 0.0F, 0.0F, 8, 5, 10);
/*  61 */     this.tail2.setRotationPoint(0.0F, 12.0F, 66.0F);
/*  62 */     this.tail2.setTextureSize(256, 256);
/*  63 */     this.tail2.mirror = true;
/*  64 */     setRotation(this.tail2, 0.0F, 0.0F, 0.0F);
/*  65 */     this.tailfin1 = new ModelRenderer(this, 186, 43);
/*  66 */     this.tailfin1.addBox(0.0F, 0.0F, 0.0F, 17, 2, 11);
/*  67 */     this.tailfin1.setRotationPoint(2.0F, 13.0F, 74.0F);
/*  68 */     this.tailfin1.setTextureSize(256, 256);
/*  69 */     this.tailfin1.mirror = true;
/*  70 */     setRotation(this.tailfin1, 0.0872665F, -0.0872665F, 0.0F);
/*  71 */     this.tailfin2 = new ModelRenderer(this, 186, 59);
/*  72 */     this.tailfin2.addBox(-17.0F, 0.0F, 0.0F, 17, 2, 11);
/*  73 */     this.tailfin2.setRotationPoint(-2.0F, 13.0F, 74.0F);
/*  74 */     this.tailfin2.setTextureSize(256, 256);
/*  75 */     this.tailfin2.mirror = true;
/*  76 */     setRotation(this.tailfin2, 0.0872665F, 0.0872665F, 0.0F);
/*  77 */     this.backfin = new ModelRenderer(this, 0, 15);
/*  78 */     this.backfin.addBox(-0.5F, 0.0F, 0.0F, 1, 4, 8);
/*  79 */     this.backfin.setRotationPoint(0.0F, 8.0F, 11.0F);
/*  80 */     this.backfin.setTextureSize(256, 256);
/*  81 */     this.backfin.mirror = true;
/*  82 */     setRotation(this.backfin, 0.3665191F, 0.0F, 0.0F);
/*  83 */     this.head = new ModelRenderer(this, 0, 155);
/*  84 */     this.head.addBox(-8.0F, 0.0F, -16.0F, 16, 8, 22);
/*  85 */     this.head.setRotationPoint(0.0F, 11.0F, -6.0F);
/*  86 */     this.head.setTextureSize(256, 256);
/*  87 */     this.head.mirror = true;
/*  88 */     setRotation(this.head, 0.0F, 0.0F, 0.0F);
/*  89 */     this.jaw = new ModelRenderer(this, 0, 130);
/*  90 */     this.jaw.addBox(-7.0F, -1.0F, -20.0F, 14, 2, 20);
/*  91 */     this.jaw.setRotationPoint(0.0F, 20.0F, 0.0F);
/*  92 */     this.jaw.setTextureSize(256, 256);
/*  93 */     this.jaw.mirror = true;
/*  94 */     setRotation(this.jaw, 0.0698132F, 0.0F, 0.0F);
/*  95 */     this.lfin1 = new ModelRenderer(this, 96, 0);
/*  96 */     this.lfin1.addBox(0.0F, -1.0F, -3.0F, 4, 3, 6);
/*  97 */     this.lfin1.setRotationPoint(10.0F, 18.0F, 8.0F);
/*  98 */     this.lfin1.setTextureSize(256, 256);
/*  99 */     this.lfin1.mirror = true;
/* 100 */     setRotation(this.lfin1, 0.0F, -0.0872665F, 0.0F);
/* 101 */     this.lfin2 = new ModelRenderer(this, 120, 0);
/* 102 */     this.lfin2.addBox(2.0F, -0.5F, -3.0F, 22, 2, 8);
/* 103 */     this.lfin2.setRotationPoint(10.0F, 18.0F, 8.0F);
/* 104 */     this.lfin2.setTextureSize(256, 256);
/* 105 */     this.lfin2.mirror = true;
/* 106 */     setRotation(this.lfin2, 0.0F, -0.0872665F, 0.0F);
/* 107 */     this.rfin1 = new ModelRenderer(this, 96, 12);
/* 108 */     this.rfin1.addBox(-4.0F, -1.0F, -3.0F, 4, 3, 6);
/* 109 */     this.rfin1.setRotationPoint(-10.0F, 18.0F, 8.0F);
/* 110 */     this.rfin1.setTextureSize(256, 256);
/* 111 */     this.rfin1.mirror = true;
/* 112 */     setRotation(this.rfin1, 0.0F, 0.0872665F, 0.0F);
/* 113 */     this.rfin2 = new ModelRenderer(this, 120, 13);
/* 114 */     this.rfin2.addBox(-24.0F, -0.5F, -3.0F, 22, 2, 8);
/* 115 */     this.rfin2.setRotationPoint(-10.0F, 18.0F, 8.0F);
/* 116 */     this.rfin2.setTextureSize(256, 256);
/* 117 */     this.rfin2.mirror = true;
...
/* 175 */     model.rotateAngleX = x;
/* 176 */     model.rotateAngleY = y;
/* 177 */     model.rotateAngleZ = z;
/*     */   }
/*     */ 
/*     */   
/*     */   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
/* 182 */     super.setRotationAngles(par1, par2, par3, par4, par5, par6, par7Entity);
/*     */   }
/*     */ }


/* Location:              C:\Users\Admin\Downloads\orespawn-1.7.10-20.3-deobf.jar!\danger\orespawn\ModelWhale.class
