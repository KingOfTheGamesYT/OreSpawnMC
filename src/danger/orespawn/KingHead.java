...
/*  80 */     getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(OreSpawnMain.TheKing_stats.health);
...
/*     */     
/* 135 */     List var5 = this.worldObj.getEntitiesWithinAABB(TheKing.class, this.boundingBox.expand(48.0D, 32.0D, 48.0D));
...
/*     */ 
/*     */       
/* 241 */       List var5 = this.worldObj.getEntitiesWithinAABB(TheKing.class, this.boundingBox.expand(32.0D, 32.0D, 32.0D));
...
/* Location:              C:\Users\Admin\Downloads\orespawn-1.7.10-20.3-deobf.jar!\danger\orespawn\KingHead.class
