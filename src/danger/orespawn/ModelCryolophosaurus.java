...
/* 168 */     super.render(entity, f, f1, f2, f3, f4, f5);
/* 169 */     setRotationAngles(f, f1, f2, f3, f4, f5, entity);
/*     */     
/* 171 */     float newangle = 0.0F;
/*     */     
/* 173 */     if (f1 > 0.1D) {
/* 174 */       newangle = MathHelper.cos(f2 * 1.3F * this.wingspeed) * 3.1415927F * 0.25F * f1;
/*     */     } else {
/* 176 */       newangle = 0.0F;
/*     */     } 
/*     */     
/* 179 */     this.rightleg.rotateAngleX = -0.2792527F + newangle;
/* 180 */     this.rightleg2.rotateAngleX = 0.384F + newangle;
/* 181 */     this.rightleg3.rotateAngleX = -0.68F + newangle;
/* 182 */     this.rightleg4.rotateAngleX = newangle;
/*     */     
/* 184 */     this.leftleg.rotateAngleX = -0.2792527F - newangle;
/* 185 */     this.leftleg2.rotateAngleX = 0.384F - newangle;
/* 186 */     this.leftleg3.rotateAngleX = -0.68F - newangle;
/* 187 */     this.leftleg4.rotateAngleX = -newangle;
/*     */     
/* 189 */     this.jaw.rotateAngleX = -1.15F + MathHelper.cos(f2 * 0.28F) * 3.1415927F * 0.1F;
/*     */     
/* 191 */     this.Shape1.render(f5);
/* 192 */     this.Shape2.render(f5);
/* 193 */     this.Shape3.render(f5);
/* 194 */     this.jaw.render(f5);
/* 195 */     this.Shape5.render(f5);
/* 196 */     this.Shape6.render(f5);
/* 197 */     this.Shape7.render(f5);
/* 198 */     this.Shape8.render(f5);
/* 199 */     this.Shape9.render(f5);
/* 200 */     this.rightleg.render(f5);
/* 201 */     this.Shape11.render(f5);
/* 202 */     this.rightleg2.render(f5);
/* 203 */     this.rightleg3.render(f5);
/* 204 */     this.rightleg4.render(f5);
/* 205 */     this.leftleg.render(f5);
/* 206 */     this.Shape16.render(f5);
/* 207 */     this.Shape17.render(f5);
/* 208 */     this.leftleg2.render(f5);
/* 209 */     this.leftleg3.render(f5);
/* 210 */     this.leftleg4.render(f5);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              C:\Users\Admin\Downloads\orespawn-1.7.10-20.3-deobf.jar!\danger\orespawn\ModelCryolophosaurus.class
