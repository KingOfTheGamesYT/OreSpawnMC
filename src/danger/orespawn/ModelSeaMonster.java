...
/*  45 */     this.TailTip.addBox(-1.0F, -1.0F, 0.0F, 2, 2, 6);
/*  46 */     this.TailTip.setRotationPoint(0.0F, 16.0F, 70.0F);
/*  47 */     this.TailTip.setTextureSize(256, 128);
/*  48 */     this.TailTip.mirror = true;
/*  49 */     setRotation(this.TailTip, 0.0F, 0.0F, 0.0F);
/*  50 */     this.TailBase = new ModelRenderer(this, 68, 64);
/*  51 */     this.TailBase.addBox(-7.0F, -7.0F, 0.0F, 14, 14, 12);
/*  52 */     this.TailBase.setRotationPoint(0.0F, 16.0F, 26.0F);
/*  53 */     this.TailBase.setTextureSize(256, 128);
/*  54 */     this.TailBase.mirror = true;
/*  55 */     setRotation(this.TailBase, 0.0F, 0.0F, 0.0F);
/*  56 */     this.Tail2 = new ModelRenderer(this, 74, 90);
/*  57 */     this.Tail2.addBox(-6.0F, -6.0F, 0.0F, 12, 12, 8);
/*  58 */     this.Tail2.setRotationPoint(0.0F, 16.0F, 38.0F);
/*  59 */     this.Tail2.setTextureSize(256, 128);
/*  60 */     this.Tail2.mirror = true;
/*  61 */     setRotation(this.Tail2, 0.0F, 0.0F, 0.0F);
/*  62 */     this.Tail3 = new ModelRenderer(this, 78, 110);
/*  63 */     this.Tail3.addBox(-5.0F, -5.0F, 0.0F, 10, 10, 6);
/*  64 */     this.Tail3.setRotationPoint(0.0F, 16.0F, 46.0F);
/*  65 */     this.Tail3.setTextureSize(256, 128);
/*  66 */     this.Tail3.mirror = true;
/*  67 */     setRotation(this.Tail3, 0.0F, 0.0F, 0.0F);
/*  68 */     this.BodyBack = new ModelRenderer(this, 62, 32);
/*  69 */     this.BodyBack.addBox(-8.0F, -8.0F, 0.0F, 16, 16, 16);
/*  70 */     this.BodyBack.setRotationPoint(0.0F, 16.0F, 10.0F);
/*  71 */     this.BodyBack.setTextureSize(256, 128);
/*  72 */     this.BodyBack.mirror = true;
/*  73 */     setRotation(this.BodyBack, 0.0F, 0.0F, 0.0F);
/*  74 */     this.Neck6 = new ModelRenderer(this, 20, 28);
/*  75 */     this.Neck6.addBox(-2.0F, -6.0F, -2.0F, 4, 6, 4);
/*  76 */     this.Neck6.setRotationPoint(0.0F, -21.0F, -25.0F);
/*  77 */     this.Neck6.setTextureSize(256, 128);
/*  78 */     this.Neck6.mirror = true;
/*  79 */     setRotation(this.Neck6, 1.22173F, 0.0F, 0.0F);
/*  80 */     this.BodyFront = new ModelRenderer(this, 62, 0);
/*  81 */     this.BodyFront.addBox(-8.0F, -8.0F, -16.0F, 16, 16, 16);
/*  82 */     this.BodyFront.setRotationPoint(0.0F, 16.0F, 10.0F);
/*  83 */     this.BodyFront.setTextureSize(256, 128);
/*  84 */     this.BodyFront.mirror = true;
/*  85 */     setRotation(this.BodyFront, 0.0F, 0.0F, 0.0F);
/*  86 */     this.NeckBase = new ModelRenderer(this, 8, 96);
/*  87 */     this.NeckBase.addBox(-5.0F, -10.0F, -5.0F, 10, 10, 10);
/*  88 */     this.NeckBase.setRotationPoint(0.0F, 12.0F, -2.0F);
/*  89 */     this.NeckBase.setTextureSize(256, 128);
/*  90 */     this.NeckBase.mirror = true;
/*  91 */     setRotation(this.NeckBase, 0.7853982F, 0.0F, 0.0F);
/*  92 */     this.Neck2 = new ModelRenderer(this, 14, 78);
/*  93 */     this.Neck2.addBox(-3.0F, -10.0F, -4.0F, 6, 10, 8);
/*  94 */     this.Neck2.setRotationPoint(0.0F, 6.0F, -9.0F);
/*  95 */     this.Neck2.setTextureSize(256, 128);
/*  96 */     this.Neck2.mirror = true;
/*  97 */     setRotation(this.Neck2, 0.6981317F, 0.0F, 0.0F);
/*  98 */     this.Neck3 = new ModelRenderer(this, 16, 62);
/*  99 */     this.Neck3.addBox(-3.0F, -10.0F, -3.0F, 6, 10, 6);
/* 100 */     this.Neck3.setRotationPoint(0.0F, -1.0F, -15.0F);
/* 101 */     this.Neck3.setTextureSize(256, 128);
/* 102 */     this.Neck3.mirror = true;
/* 103 */     setRotation(this.Neck3, 0.5235988F, 0.0F, 0.0F);
/* 104 */     this.Neck4 = new ModelRenderer(this, 20, 48);
/* 105 */     this.Neck4.addBox(-2.0F, -10.0F, -2.0F, 4, 10, 4);
/* 106 */     this.Neck4.setRotationPoint(0.0F, -9.0F, -20.0F);
/* 107 */     this.Neck4.setTextureSize(256, 128);
/* 108 */     this.Neck4.mirror = true;
/* 109 */     setRotation(this.Neck4, 0.2617994F, 0.0F, 0.0F);
/* 110 */     this.Neck5 = new ModelRenderer(this, 20, 38);
/* 111 */     this.Neck5.addBox(-2.0F, -6.0F, -2.0F, 4, 6, 4);
/* 112 */     this.Neck5.setRotationPoint(0.0F, -17.6F, -22.0F);
/* 113 */     this.Neck5.setTextureSize(256, 128);
/* 114 */     this.Neck5.mirror = true;
/* 115 */     setRotation(this.Neck5, 0.7853982F, 0.0F, 0.0F);
/* 116 */     this.BottomJaw = new ModelRenderer(this, 10, 0);
/* 117 */     this.BottomJaw.addBox(-4.0F, 0.0F, -10.0F, 8, 3, 10);
/* 118 */     this.BottomJaw.setRotationPoint(0.0F, -23.0F, -29.0F);
/* 119 */     this.BottomJaw.setTextureSize(256, 128);
/* 120 */     this.BottomJaw.mirror = true;
/* 121 */     setRotation(this.BottomJaw, 0.1745329F, 0.0F, 0.0F);
/* 122 */     this.FinBackRight = new ModelRenderer(this, 132, 95);
/* 123 */     this.FinBackRight.addBox(-8.0F, 0.0F, 0.0F, 8, 1, 16);
/* 124 */     this.FinBackRight.setRotationPoint(-7.0F, 16.0F, 16.0F);
/* 125 */     this.FinBackRight.setTextureSize(256, 128);
/* 126 */     this.FinBackRight.mirror = true;
/* 127 */     setRotation(this.FinBackRight, -0.5235988F, -0.6981317F, 0.0F);
/* 128 */     this.FinBackLeft = new ModelRenderer(this, 132, 61);
/* 129 */     this.FinBackLeft.addBox(0.0F, 0.0F, 0.0F, 8, 1, 16);
/* 130 */     this.FinBackLeft.setRotationPoint(7.0F, 16.0F, 16.0F);
/* 131 */     this.FinBackLeft.setTextureSize(256, 128);
/* 132 */     this.FinBackLeft.mirror = true;
/* 133 */     setRotation(this.FinBackLeft, -0.5235988F, 0.6981317F, 0.0F);
/* 134 */     this.FinFrontLeft = new ModelRenderer(this, 132, 44);
/* 135 */     this.FinFrontLeft.addBox(0.0F, 0.0F, 0.0F, 8, 1, 16);
/* 136 */     this.FinFrontLeft.setRotationPoint(7.0F, 16.0F, -1.0F);
/* 137 */     this.FinFrontLeft.setTextureSize(256, 128);
/* 138 */     this.FinFrontLeft.mirror = true;
/* 139 */     setRotation(this.FinFrontLeft, -0.5235988F, 0.6981317F, 0.0F);
/* 140 */     this.FinFrontRight = new ModelRenderer(this, 132, 78);
/* 141 */     this.FinFrontRight.addBox(-8.0F, 0.0F, 0.0F, 8, 1, 16);
/* 142 */     this.FinFrontRight.setRotationPoint(-7.0F, 16.0F, -1.0F);
/* 143 */     this.FinFrontRight.setTextureSize(256, 128);
/* 144 */     this.FinFrontRight.mirror = true;
/* 145 */     setRotation(this.FinFrontRight, -0.5235988F, -0.6981317F, 0.0F);
/* 146 */     this.Tail4 = new ModelRenderer(this, 152, 0);
/* 147 */     this.Tail4.addBox(-4.0F, -4.0F, 0.0F, 8, 8, 6);
/* 148 */     this.Tail4.setRotationPoint(0.0F, 16.0F, 52.0F);
/* 149 */     this.Tail4.setTextureSize(256, 128);
/* 150 */     this.Tail4.mirror = true;
/* 151 */     setRotation(this.Tail4, 0.0F, 0.0F, 0.0F);
/* 152 */     this.Tail5 = new ModelRenderer(this, 154, 14);
/* 153 */     this.Tail5.addBox(-3.0F, -3.0F, 0.0F, 6, 6, 6);
/* 154 */     this.Tail5.setRotationPoint(0.0F, 16.0F, 58.0F);
/* 155 */     this.Tail5.setTextureSize(256, 128);
/* 156 */     this.Tail5.mirror = true;
/* 157 */     setRotation(this.Tail5, 0.0F, 0.0F, 0.0F);
/* 158 */     this.Tail6 = new ModelRenderer(this, 156, 26);
/* 159 */     this.Tail6.addBox(-2.0F, -2.0F, 0.0F, 4, 4, 6);
/* 160 */     this.Tail6.setRotationPoint(0.0F, 16.0F, 64.0F);
/* 161 */     this.Tail6.setTextureSize(256, 128);
/* 162 */     this.Tail6.mirror = true;
/* 163 */     setRotation(this.Tail6, 0.0F, 0.0F, 0.0F);
/* 164 */     this.TopJaw = new ModelRenderer(this, 10, 13);
/* 165 */     this.TopJaw.addBox(-4.0F, -4.0F, -10.0F, 8, 4, 10);
/* 166 */     this.TopJaw.setRotationPoint(0.0F, -23.0F, -29.0F);
/* 167 */     this.TopJaw.setTextureSize(256, 128);
/* 168 */     this.TopJaw.mirror = true;
/* 169 */     setRotation(this.TopJaw, 0.0F, 0.0F, 0.0F);
/* 170 */     this.RightEye = new ModelRenderer(this, 46, 16);
/* 171 */     this.RightEye.addBox(-3.0F, -6.0F, -5.0F, 2, 2, 1);
/* 172 */     this.RightEye.setRotationPoint(0.0F, -23.0F, -29.0F);
/* 173 */     this.RightEye.setTextureSize(256, 128);
/* 174 */     this.RightEye.mirror = true;
/* 175 */     setRotation(this.RightEye, 0.0F, 0.0F, 0.0F);
/* 176 */     this.LeftEye = new ModelRenderer(this, 4, 16);
/* 177 */     this.LeftEye.addBox(1.0F, -6.0F, -5.0F, 2, 2, 1);
/* 178 */     this.LeftEye.setRotationPoint(0.0F, -23.0F, -29.0F);
/* 179 */     this.LeftEye.setTextureSize(256, 128);
/* 180 */     this.LeftEye.mirror = true;
...
/* 321 */     model.rotateAngleX = x;
/* 322 */     model.rotateAngleY = y;
/* 323 */     model.rotateAngleZ = z;
/*     */   }
/*     */ 
/*     */   
/*     */   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
/* 328 */     super.setRotationAngles(par1, par2, par3, par4, par5, par6, par7Entity);
/*     */   }
/*     */ }


/* Location:              C:\Users\Admin\Downloads\orespawn-1.7.10-20.3-deobf.jar!\danger\orespawn\ModelSeaMonster.class
